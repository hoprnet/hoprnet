export default function(){
  return (
      <svg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 196 196' style='enable-background:new 0 0 196 196;' xmlSpace='preserve'>
