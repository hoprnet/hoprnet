...
No Python SDK is available to connect to the HOPRd API, however it can be generated by using this [script](/scripts/generate-python-sdk.sh).
The script can be adapted to generate the sdk for a different programing language.
