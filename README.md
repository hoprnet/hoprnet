...
- `HOPR_INTERNAL_MIXER_MINIMUM_DELAY_IN_MS` - the minimum delay in milliseconds that happens inside the mixer
- `HOPR_INTERNAL_MIXER_MAXIMUM_DELAY_IN_MS` - the maximum delay in milliseconds that happens inside the mixer
