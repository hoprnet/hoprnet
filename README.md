...
Options:
  ...
  --ws                          Run a WS interface on localhost:3002, requires --apiToken  [boolean] [default: false]
  --wsHost                      Updates the host for the WS server  [default: "localhost"]
  --wsPort                      Updates the port for the WS server  [default: 3002]
