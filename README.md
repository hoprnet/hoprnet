...
Options:
  ...
  --rest                        (deprecated) Alias of `--api`, requires --apiToken  [boolean]
  --restHost                    (deprecated) Alias of `--apiHost`  [string] [default: "localhost"]
  --restPort                    (deprecated) Alias of `--apiPort`  [number] [default: 3001]
  --api                         Expose the Rest (V1, V2) and Websocket (V2) API on localhost:3001, requires --apiToken  [boolean] [default: false]
  --apiHost                     Set host IP to which both Rest and Websocket API server will bind  [string] [default: "localhost"]
  --apiPort                     Set host port to which both Rest and Websocket API server will bind  [number] [default: 3001]
