...
in
{
  ...
  hoprd = builders.local.callPackage ../rust-package.nix (mkHoprdBuildArgs {
    src = sources.main;
  ...
  hoprd-x86_64-linux = builders.x86_64-linux.callPackage ../rust-package.nix (mkHoprdBuildArgs {
    src = sources.main;
    depsSrc = sources.deps;
  });
  ...
  hoprd-aarch64-linux = builders.aarch64-linux.callPackage ../rust-package.nix (mkHoprdBuildArgs {
    src = sources.main;
    depsSrc = sources.deps;
  });
  ...
  hoprd-x86_64-darwin = builders.x86_64-darwin.callPackage ../rust-package.nix (mkHoprdBuildArgs {
    src = sources.main;
    depsSrc = sources.deps;
  });
  ...
  hoprd-aarch64-darwin = builders.aarch64-darwin.callPackage ../rust-package.nix (mkHoprdBuildArgs {
    src = sources.main;
    depsSrc = sources.deps;
  });
