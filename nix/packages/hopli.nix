...
{
  # Development builds
  hopli = builders.local.callPackage ../rust-package.nix (mkHopliBuildArgs {
    src = sources.main;
  ...
  hopli-x86_64-linux = builders.x86_64-linux.callPackage ../rust-package.nix (mkHopliBuildArgs {
    src = sources.main;
    depsSrc = sources.deps;
  });
  ...
  # ARM64 Linux builds
  hopli-aarch64-linux = builders.aarch64-linux.callPackage ../rust-package.nix (mkHopliBuildArgs {
    src = sources.main;
    depsSrc = sources.deps;
  });
  ...
  hopli-x86_64-darwin = builders.x86_64-darwin.callPackage ../rust-package.nix (mkHopliBuildArgs {
    src = sources.main;
    depsSrc = sources.deps;
  });

  # ARM64 macOS (Apple Silicon)
  hopli-aarch64-darwin = builders.aarch64-darwin.callPackage ../rust-package.nix (mkHopliBuildArgs {
    src = sources.main;
    depsSrc = sources.deps;
  });
