...
#[cfg(feature = "std")]
impl<InternalGenerator: Rng<OUTPUT>, const OUTPUT: usize> std::io::Read for BufferedRng<InternalGenerator, OUTPUT> {
...
impl<InternalGenerator: SeedableRng<SEED_SIZE, OUTPUT>, const OUTPUT: usize, const SEED_SIZE: usize>
