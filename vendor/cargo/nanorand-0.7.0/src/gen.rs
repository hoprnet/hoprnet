...
range!((u8, u16, i8), (u16, u32, i16), (u32, u64, i32), (u64, u128, i64));
...
mod tests {
    ...
    fn ensure_unsigned_in_range() {
        ...
        for _ in 0..1000 {
            ...
            assert!((10..=20).contains(&number), "{} was outside of 10..=20", number);

            let number = rng.generate_range(10_u64..30);
            assert!((10..30).contains(&number), "{} was outside of 10..30", number);
            ...
            assert!((..1024).contains(&number), "{} was outside of ..1024", number);
        }
    }
    #[test]
