...
const SuperBoxSearch = ({ nodesVerified, nodesRegistered, nodesConnected, searchTerm, setSearchTerm, match }) => {
  ...
  return (
    <div className="aux-super-tab">
     ...
     <p className="help-total-results">Total results: <span>{match}</span></p>
     <input
        className="search"
        type="text"
