...
export function toLengthPrefixedU8a(arg: Uint8Array, additionalPadding?: Uint8Array, length?: number) {
  if (additionalPadding != null) {
    ...
    if (length != null) {
      return u8aConcat(toU8a(arg.length, LENGTH_PREFIX_LENGTH), additionalPadding, arg, new Uint8Array(length - LENGTH_PREFIX_LENGTH - additionalPadding.length - arg.length))
    } else {
    ...
    if (length != null) {
      return u8aConcat(toU8a(arg.length, LENGTH_PREFIX_LENGTH), arg, new Uint8Array(length - LENGTH_PREFIX_LENGTH - arg.length))
    } else {
