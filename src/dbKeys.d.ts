 ...
 */
export function Channel<ConcreteAccountId extends AccountId>(counterparty: ConcreteAccountId): Uint8Array
 ...
 */
export function Challenge<ConcreteHash extends Hash>(channelId: ConcreteHash, challenge: ConcreteHash): Uint8Array
 ...
 */
export function ChannelId<ConcreteHash extends Hash>(signatureHash: ConcreteHash): Uint8Array
 ...
 */
export function Nonce<ConcreteHash extends Hash>(channelId: ConcreteHash, nonce: ConcreteHash): Uint8Array
 ...
 */
export function Ticket<ConcreteHash extends Hash>(channelId: ConcreteHash, challenge: ConcreteHash): Uint8Array