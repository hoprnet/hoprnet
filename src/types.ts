...
export interface PublicNodesEmitter {
  ...
  addListener(event: RemoveEventName, listener: (removeNode: Multiaddr) => void): this
  addListener(event: string | symbol, listener: (...args: any[]) => void): this

  emit(event: AddEventName | RemoveEventName): boolean
  emit(event: AddEventName, newNode: Multiaddr): boolean
  emit(event: RemoveEventName, removeNode: Multiaddr): boolean
  ...
  on(event: RemoveEventName, listener: (removeNode: Multiaddr) => void): this
  ...
  once(event: RemoveEventName, listener: (removeNode: Multiaddr) => void): this
  ...
  prependListener(event: RemoveEventName, listener: (removeNode: Multiaddr) => void): this
  ...
  prependOnceListener(event: RemoveEventName, listener: (removeNode: Multiaddr) => void): this
  ...
  removeListener(event: RemoveEventName, listener: (removeNode: Multiaddr) => void): this
