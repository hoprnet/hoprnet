...
import { getParties, time, wait, pubKeyToAccountId, privKeyToPubKey } from '../utils'
...
describe('test indexer', function () {
  ...
  context('unit tests', function () {
    ...
    it('should emit on manipulated events', async function () {
      console.log((await pubKeyToAccountId(await privKeyToPubKey(stringToU8a(testconfigs.DEMO_ACCOUNTS[1])))).toHex())
