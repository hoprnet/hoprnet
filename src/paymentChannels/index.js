...
class PaymentChannel extends EventEmitter {
     ...
     * is fired.
     */
    registerSettlementListener(channelId, listener = this.close) {
     ...
     * is fired.
     */
    registerOpeningListener(channelId, listener) {
        ...
        this.contract.once('OpenedChannel', {
            topics: [`0x${channelId.toString('hex')}`, this.web3.utils.sha3(`OpenedChannel(bytes32,uint256,uint256)`)]
        }, listener)
    }
