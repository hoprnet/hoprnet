...
pub trait HoprDbTicketOperations {
    ...
    /// Counts the total value of tickets matching the [`selector`](TicketSelector).
    ///
    /// Returns the total ticket value.
    async fn get_tickets_value(&self, selector: TicketSelector) -> Result<HoprBalance, Self::Error>;
