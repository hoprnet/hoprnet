...
[^4]:
    ...
    release. The latest stable release known at the time of writing is [`paleochora`](https://github.com/hoprnet/hoprnet/archive/refs/heads/release/paleochora.zip).
