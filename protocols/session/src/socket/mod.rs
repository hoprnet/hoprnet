...
mod tests {
    ...
    async fn stateless_socket_unidirectional_should_work() -> anyhow::Result<()> {
        ...
        let data = hopr_api::types::crypto_random::random_bytes::<DATA_SIZE>();
    ...
    async fn stateless_socket_bidirectional_should_work() -> anyhow::Result<()> {
        ...
        let alice_sent_data = hopr_api::types::crypto_random::random_bytes::<DATA_SIZE>();
        alice_socket
        ...
        let bob_sent_data = hopr_api::types::crypto_random::random_bytes::<DATA_SIZE>();
        bob_socket
