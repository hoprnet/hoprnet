use hopr_api::types::{crypto::types::PacketTag, crypto_random::random_bytes};
...
#[cfg(test)]
mod tests {
    use hopr_api::types::crypto::types::PACKET_TAG_LENGTH;
    ...
    fn tag_bloom_filter_wrap_around() {
        ...
        for _ in 1..filter.capacity() {
            let mut tag: PacketTag = hopr_api::types::crypto_random::random_bytes();
