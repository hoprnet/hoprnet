...
setup_node 3304 9094 "${node4_dir}" "${node4_log}" "${node4_id}"
setup_node 3305 9095 "${node5_dir}" "${node5_log}" "${node5_id}"
setup_node 3306 9096 "${node6_dir}" "${node6_log}" "${node6_id}" "--run \"info;balance\""
# }}}
