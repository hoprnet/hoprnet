...
#  --- Run nodes --- {{{
setup_node 13301 19091 "${node1_dir}" "${node1_log}" "${node1_id}" "${npm_package_version}"
setup_node 13302 19092 "${node2_dir}" "${node2_log}" "${node2_id}" "${npm_package_version}"
setup_node 13303 19093 "${node3_dir}" "${node3_log}" "${node3_id}" "${npm_package_version}"
setup_node 13304 19094 "${node4_dir}" "${node4_log}" "${node4_id}" "${npm_package_version}"
setup_node 13305 19095 "${node5_dir}" "${node5_log}" "${node5_id}" "${npm_package_version}"
setup_node 13306 19096 "${node6_dir}" "${node6_log}" "${node6_id}" "${npm_package_version}" "--run \"info;balance\""
# }}}
