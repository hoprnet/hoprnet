...
HOPR_ENVIRONMENT_ID="hardhat-localhost" TS_NODE_PROJECT=${mydir}/../packages/ethereum/tsconfig.hardhat.json yarn workspace @hoprnet/hopr-ethereum exec "hardhat node" \
  --show-stack-traces > \
  "${hardhat_rpc_log}" 2>&1 &
