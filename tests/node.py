...
class Node:
    ...
    def setup(self, password: str, config_file: Path, dir: Path):
        ...
        custom_env = {
            "RUST_LOG": f"{log_level},libp2p_swarm=debug,libp2p_mplex=info,multistream_select=info,isahc::handler=error,isahc::client=error,sqlx::query=warn,sea_orm::driver=warn",
            "RUST_BACKTRACE": "full",
