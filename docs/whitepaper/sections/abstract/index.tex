...
Another project based on onion routing is I2P network. I2P has different design choices from those of Tor:
\begin{itemize}
    ...
    \item Unidirectional instead of bidirectional tunnels
    \item Peer profiles instead of directory authorities
