...
![Currently HOPR Chat is about ~0.5 GB, please be patient.](../.gitbook/assets/docker_install_macos%20%283%29.gif)
...
![HOPR Chat distributed as a Docker image](../.gitbook/assets/docker_images%20%283%29.gif)
...
![](../.gitbook/assets/node%20%284%29.gif)
...
![](../.gitbook/assets/hopr%20%283%29.gif)
...
![Please select the correct distribution for your operating system.](../.gitbook/assets/image%20%288%29%20%283%29.png)
...
![The crawl command will show you other connected nodes.](../.gitbook/assets/running_hopr_chat_and_crawling%20%283%29.gif)
...
![Your message will be sent privately through the HOPR network](../.gitbook/assets/running_hopr_chat_and_sending%20%283%29.gif)
