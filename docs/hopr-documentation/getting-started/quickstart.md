...
![](../.gitbook/assets/windows_install_nodejs%20%283%29.webp)
...
![](../.gitbook/assets/powershell_open%20%283%29.webp)
{% endtab %}
...
![](../.gitbook/assets/terminal_open%20%283%29.webp)
{% endtab %}
...
![Type &#x201C;node -v&#x201D; to find your node version. It should show v12.18.2](../.gitbook/assets/node-version%20%283%29.gif)
...
![](../.gitbook/assets/downloading_hopr_bin%20%283%29.webp)
{% endtab %}

{% tab title="MacOS" %}
For MacOS, just double click on the `.zip` file you downloaded to see the contents of the **HOPR Chat** application.

![HOPR Chat contents of the extracted content should look as follows.](../.gitbook/assets/hopr-macos-contents%20%285%29.webp)
...
![HOPR Chat contents extracted as seen in a Linux terminal using the ls command](../.gitbook/assets/hopr-linux-contents%20%285%29.webp)
{% endtab %}
{% endtabs %}
...
![HOPR Chat executable file for Windows.](../.gitbook/assets/image%20%2814%29%20%283%29.png)
{% endtab %}
...
![HOPR Chat executable as seen in MacOS](../.gitbook/assets/hopr-macos-contents%20%286%29.webp)
...
![](../.gitbook/assets/hopr_macos_gatekeeper%20%283%29.webp)
{% endtab %}
...
![HOPR Chat executable as seen in a Linux terminal](../.gitbook/assets/hopr-linux-contents%20%286%29.webp)
{% endtab %}
{% endtabs %}

Running these commands will bring up a screen similar the one shown below. Congratulations! You are now running **HOPR Chat**.

![HOPR Chat Testnet up and running.](../.gitbook/assets/hopr-chat-testnet%20%284%29.gif)
