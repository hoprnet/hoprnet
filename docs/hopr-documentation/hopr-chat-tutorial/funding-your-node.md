...
Once you've sent xDAI to your node, restart **HOPR Chat** or your **HOPR PC Node**. When your node restarts, your balance will be automatically detected and you can proceed to the [registration stage](../core-concepts/cover-traffic/coverbot.md).
...
To learn more about earning xHOPR by relaying data, see the sections on [**Multi-hop messages**](../hopr-avado-node-tutorial/sending-a-multi-hop-message.md) and [**Tickets**](redeeming-tickets.md).
