...
```bash
docker run --pull always -ti -v $HOME/.hoprd-db:/app/db -p 9091:9091 
-p 3000:3000 -p 3001:3001 gcr.io/hoprassociation/hoprd:athens --admin 
--password 'open-sesame-iTwnsPNg0hpagP+o6T0KOwiH9RQ0' --init --rest 
--restHost "0.0.0.0" --restPort 3001 --identity /app/db/.hopr-id-athens 
--apiToken '<YOUR_SECRET_TOKEN>' --adminHost "0.0.0.0" --adminPort 3000 
--host "0.0.0.0:9091"
```
