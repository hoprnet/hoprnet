...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[auto]
        ...
        \draw [->,draw,dashed] (b.east) to node [align=center,below] {packet$_{i-1}$} node [align=center,above,circle,draw] {1} (c.west);
        \draw [->,draw,dashed] (c.east) to node [align=center,below] {packet$_i$} (d.west);
        \draw [->,draw,dashed] (d.east) to node [align=center,below] {packet$_{i+1}$} (e.west);

        \draw [->,draw] (c.south) to node [right] {$s_i^{own}$} node [align=center,left,circle,draw] {2}  (intermediateResult.north);
        \draw [->,draw,bend left] (d.south) to node[below] {$s_{i+1}^{ack}$} node [align=center,right,circle,draw] {3} (intermediateResult.east);
