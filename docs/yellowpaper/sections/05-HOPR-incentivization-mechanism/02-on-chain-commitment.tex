...
preimage-resistant hash function (we use the keccak256 hash function, which is also used
...
private key or not. \\~\\The master key should be pseudo-random, such that
