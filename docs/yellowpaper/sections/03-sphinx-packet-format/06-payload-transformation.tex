...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \draw[decoration={brace,raise=5pt},decorate] (0,0.05) -- node[left=10pt] {padding} (0,0.5-0.05);
        ...
        \begin{scope}[shift={(0,-0.5)}]
            \draw[decoration={brace,raise=5pt},decorate] (0,0.05) -- node[left=10pt] {tag} (0,0.5-0.05);
            \draw [draw] (0,0) rectangle (2,0.5);
            \draw (1,0.25) node {$\mathtt{HOPR}$};
        \end{scope}

        \begin{scope}[shift={(0,-1)}]
            \draw[decoration={brace,raise=5pt},decorate] (0,0.05) -- node[left=10pt] {payload} (0,0.5-0.05);
