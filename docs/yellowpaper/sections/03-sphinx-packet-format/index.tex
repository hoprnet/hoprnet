...
$h:G^*\times G^*\rightarrow\mathbb{Z}^*_q$ where $\mathbb{Z}^*_q$ is the field of non-identity elements of $\mathbb{Z}_q$ (field of integers).
    ...
    and
    $$\beta_i=n_{i+1}\|\gamma_{i+1}\|\beta_{{i+1}_{[ \,0....(2r-1)\kappa-1\,] }}\oplus PRNG(s_{i})_{[ \,0....(2r+1)\kappa-1\,]} $$ for $0\le i < v-1$ and $\phi_i=\{ \phi_{i-1}\|0_{2\kappa}\}\oplus PRNG(s_{i-1})_{[ \,(2(r-i)+3)\kappa..(2r+3)\kappa-1\,]}$
