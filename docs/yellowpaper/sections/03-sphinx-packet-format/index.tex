...
=======
        \alpha_i = g^{x\Pi_{j=0}^{i=r-2}b_j} \\
        \varphi_i=y^{x\Pi_{j=0}^{j=r-2}b_j}  \\
>>>>>>> a23fbed8789e16639b80a99c58396fe8a2b30e19
