...
for processing relays. Further, Sphinx model considers the
receiver to not be part of the anonymization protocol. The
receiver’s address is included in the payload.
\begin{figure}[H]
    \centering
