...
\input{sections/03-sphinx-packet-format/03-shifting.tex}
\input{sections/03-sphinx-packet-format/04-integrity.tex}
\input{sections/03-sphinx-packet-format/05-payload-transformation.tex}
\input{sections/03-sphinx-packet-format/06-shorter-paths.tex}
