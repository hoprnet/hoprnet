...
\hyperref[sec:privacyprotocols]{Privacy protocols} cover means to hide a user's
information; (2) \hyperref[sec:l2protocols]{Ethereum layer 2 scalability
approaches} allow systems to perform micro-payments via the Ethereum blockchain.
...
\paragraph{The anonymity trilemma}, the combination of achiving low latency
