...
\begin{itemize}
    ...
    \item \textbf{Sender-receiver unlinkability}
          An adversary should be unable to distinguish whether $\{S_1\rightarrow R_1, S_2\rightarrow R_2\}$ or
    ...
    \item \textbf{Resistance to active attacks}
          An adversary must not be able to conduct active attacks such as tagging and replay attacks, where the adversary modifies and
...
\begin{itemize}
    \item \textbf{Sybil attacks}
          In a Sybil attack, an attacker forges
    ...
    \item \textbf{Eclipse attacks}
          In an eclipse attack, the attacker seeks to isolate and attack or
