...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[auto]
        ...
        \path [->,draw,bend left] (a.north east) to node [above] {3$\cdot$incentive} (b.north west);
        \path [->,draw,bend left] (b.north east) to node [above] {2$\cdot$incentive} (c.north west);
        \path [->,draw,bend left] (c.north east) to node [above] {1$\cdot$incentive} (d.north west);
        \path [->,draw,bend left] (d.north east) to node [above] {0$\cdot$incentive} (z.north west);
