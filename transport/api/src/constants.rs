...
pub const RESERVED_TAG_UPPER_LIMIT: Tag = RESERVED_SESSION_TAG_UPPER_LIMIT;
...
pub(crate) const RESERVED_SESSION_TAG_UPPER_LIMIT: Tag = 2 ^ 20;
...
pub(crate) const RESERVED_SUBPROTOCOL_TAG_UPPER_LIMIT: Tag = 16;
pub(crate) const RESERVED_PING_TAG: Tag = 0;
