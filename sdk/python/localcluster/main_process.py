...
async def bringup(
    config: str, test_mode: bool = False, fully_connected: bool = False, use_nat=False
    ...
    cluster = Cluster(config, ANVIL_CONFIG_FILE, ANVIL_FOLDER.joinpath("protocol-config.json"), use_nat)
