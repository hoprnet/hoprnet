...
//! - type representing public and private keypair and their conversion to [Scalar](shared_keys::Scalar) and [GroupElement](shared_keys::GroupElement) (by the means of the corresponding `From` trait implementation)
//!
//! Currently, there are the following [SphinxSuite](ec_groups::SphinxSuite) implementations :
//! - [Secp256k1Suite](ec_groups::Secp256k1Suite): deprecated, used in previous HOPR versions
//! - [Ed25519Suite](ec_groups::Ed25519Suite): simple implementation using Ed25519, used for testing
//! - [X25519Suite](ec_groups::X25519Suite) currently used, implemented using Curve25519 Montgomery curve for faster computation
//!
