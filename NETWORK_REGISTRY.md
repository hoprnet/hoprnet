...
```
PRIVATE_KEY=<private key of "account"> make stake-funds environment=master-goerli environment_type=staging
```
...
```
PRIVATE_KEY<private key of "account"> make stake-nrnft environment=master-goerli environment_type=staging nftrank=<rank of "Network_registry" nft>
```
...
```
PRIVATE_KEY=<private key of “account”> make self-register-node environment=master-goerli environment_type=staging peer-ids=<peerId1,peerId2,peerId3>
```
...
```
PRIVATE_KEY=<private key of “account”> make self-deregister-node environment=master-goerli environment_type=staging peer-ids=<peerId1,peerId2,peerId3>
```
...
```
make register-nodes environment=master-goerli environment_type=staging native_addresses=<address1,address2,address3,address4> peer_ids=<peerid1,peerid2,peerid3,peerid4>
make force-eligibility-update environment=master-goerli environment_type=staging native_addresses=<address1,address2,address3,address4> eligibility=<true,false,true,true, etc>
```
...
```
make deregister-nodes environment=master-goerli environment_type=staging peer_ids=<peerId1,peerId2,peerId3,peerId4>
```
...
```
make disable-network-registry environment=master-goerli environment_type=staging
```
...
- Option 1: obtain a "Network_registry" NFT (with nftrank of "developer" or "community") and register your node on NR
  ...
  ```
  make register-node-with-nft endpoint=<hoprd_endpoint> nftrank=<"Network_registry" NFT Rank> account=<staking_account> environment=master-goerli environment_type=staging
  ```
