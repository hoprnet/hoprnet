...
export class AddressClient extends grpc.Client {
  ...
  getNativeAddress(
    argument: address_pb.GetNativeAddressRequest,
    callback: grpc.requestCallback<address_pb.GetNativeAddressResponse>
  ...
  getHoprAddress(
    argument: address_pb.GetHoprAddressRequest,
    callback: grpc.requestCallback<address_pb.GetHoprAddressResponse>
  ): grpc.ClientUnaryCall
  getHoprAddress(
    argument: address_pb.GetHoprAddressRequest,
    metadataOrOptions: grpc.Metadata | grpc.CallOptions | null,
