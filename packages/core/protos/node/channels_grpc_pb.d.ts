...
export class ChannelsClient extends grpc.Client {
  ...
  getChannels(
    argument: channels_pb.GetChannelsRequest,
    callback: grpc.requestCallback<channels_pb.GetChannelsResponse>
  ...
  getChannelData(
    argument: channels_pb.GetChannelDataRequest,
    callback: grpc.requestCallback<channels_pb.GetChannelDataResponse>
  ): grpc.ClientUnaryCall
  getChannelData(
    argument: channels_pb.GetChannelDataRequest,
    metadataOrOptions: grpc.Metadata | grpc.CallOptions | null,
  ...
  openChannel(
    argument: channels_pb.OpenChannelRequest,
    callback: grpc.requestCallback<channels_pb.OpenChannelResponse>
  ): grpc.ClientUnaryCall
  openChannel(
    argument: channels_pb.OpenChannelRequest,
    metadataOrOptions: grpc.Metadata | grpc.CallOptions | null,
  ...
  closeChannel(
    argument: channels_pb.CloseChannelRequest,
    callback: grpc.requestCallback<channels_pb.CloseChannelResponse>
  ): grpc.ClientUnaryCall
  closeChannel(
    argument: channels_pb.CloseChannelRequest,
    metadataOrOptions: grpc.Metadata | grpc.CallOptions | null,
