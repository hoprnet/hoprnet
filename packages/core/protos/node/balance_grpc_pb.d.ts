...
export class BalanceClient extends grpc.Client {
  ...
  getNativeBalance(
    argument: balance_pb.GetNativeBalanceRequest,
    callback: grpc.requestCallback<balance_pb.GetNativeBalanceResponse>
  ...
  getHoprBalance(
    argument: balance_pb.GetHoprBalanceRequest,
    callback: grpc.requestCallback<balance_pb.GetHoprBalanceResponse>
  ): grpc.ClientUnaryCall
  getHoprBalance(
    argument: balance_pb.GetHoprBalanceRequest,
    metadataOrOptions: grpc.Metadata | grpc.CallOptions | null,
