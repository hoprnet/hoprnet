...
Options:
  ...
  --environment      Environment id which the node shall run on  [string] [choices: "anvil-localhost", "anvil-localhost2", "master-goerli", "debug-staging", "tuttlingen", "prague", "budapest", "athens", "lisbon", "ouagadougou", "paleochora", "monte_rosa"] [default: ""]
