...
\+ **new Challenge**(`arr`: *Uint8Array*): [*Challenge*](challenge.md)
...
▸ **toEthereumChallenge**(): [*Address*](address.md)

**Returns:** [*Address*](address.md)

Defined in: [types/challenge.ts:15](https://github.com/hoprnet/hoprnet/blob/master/packages/utils/src/types/challenge.ts#L15)
...
▸ `Static` **fromHintAndShare**(`ownShare`: [*HalfKeyChallenge*](halfkeychallenge.md), `hint`: [*HalfKeyChallenge*](halfkeychallenge.md)): [*Challenge*](challenge.md)
...
Defined in: [types/challenge.ts:7](https://github.com/hoprnet/hoprnet/blob/master/packages/utils/src/types/challenge.ts#L7)

___

### fromOwnShareAndHalfKey

▸ `Static` **fromOwnShareAndHalfKey**(`ownShare`: [*HalfKeyChallenge*](halfkeychallenge.md), `halfKey`: [*HalfKey*](halfkey.md)): [*Challenge*](challenge.md)
...
Defined in: [types/challenge.ts:11](https://github.com/hoprnet/hoprnet/blob/master/packages/utils/src/types/challenge.ts#L11)
