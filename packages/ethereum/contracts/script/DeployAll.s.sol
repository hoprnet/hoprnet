...
contract DeployAllContractsScript is Script, NetworkConfig, ERC1820RegistryFixtureTest, PermittableTokenFixtureTest {
    ...
    function run() external {
        ...
        //             "mint(address,uint256,bytes,bytes)", deployerAddress, 130000000 ether, hex"00", hex"00"
        //         )
        //     );
        ...
        //     currentNetworkDetail.hoprChannelsContractAddress =
        //         deployCode("Channels.sol:HoprChannels", abi.encode(currentNetworkDetail.hoprTokenContractAddress, closure));
        ...
        //         deployCode("HoprBoost.sol", abi.encode(deployerAddress, "https://"));
        // }
        ...
        //     string memory stakeArtifactName =
        //         string(abi.encodePacked("HoprStakeSeason", vm.toString(currentNetworkDetail.stakeSeason), ".sol"));
        ...
        //     (bool successOwnerBatchAddSpecialNftTypeAndRank,) =
        //         currentNetworkDetail.networkRegistryProxyContractAddress.call(builtProxyPayload);
        ...
        //     (bool successReadProxyOwner, bytes memory returndataProxyOwner) =
        //         currentNetworkDetail.networkRegistryProxyContractAddress.staticcall(abi.encodeWithSignature("owner()"));
        ...
        //     (bool successReadCurrentStakeContractStartTime, bytes memory returndataCurrentStakeContractStartTime) =
        ...
        //     if (
        //         linkedStakeContract != currentNetworkDetail.stakeContractAddress && proxyOwner == deployerAddress
        ...
        //     (bool successReadRequirementImplementation, bytes memory returndataRequirementImplementation) =
        ...
        //     (bool successReadOwner, bytes memory returndataOwner) =
        //         currentNetworkDetail.networkRegistryContractAddress.staticcall(abi.encodeWithSignature("owner()"));
        //     if (!successReadOwner) {
        ...
        //     (bytes memory builtNftBatchMintPayload1, bytes memory builtNftBatchMintPayload2) =
        //         buildNftBatchMintInternal(deployerAddress, DEV_BANK_ADDRESS); // This payload is built because default abi.encode returns different value (no size info) when array is static.
