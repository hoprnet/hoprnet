...
abstract contract TicketsUtilsTest is Test, AccountsFixtureTest, ChannelsUtilsTest {
  ...
  /**
     ...
     */
  HoprChannels.Ticket public TICKET_AB_WIN =
    HoprChannels.Ticket({
      channelId: CHANNEL_AB_ID,
      amount: HoprChannels.Balance.wrap(uint96(10)),
      ticketIndex: HoprChannels.TicketIndex.wrap(uint64(1)),
  ...
  /**
    ...
    */
    HoprChannels.Ticket public TICKET_BA_WIN =
    HoprChannels.Ticket({
  ...
  /**
    ...
    */
  HoprChannels.Ticket public TICKET_AB_LOSS =
    HoprChannels.Ticket({
      channelId: CHANNEL_AB_ID,
      amount: HoprChannels.Balance.wrap(uint96(10)),
      ticketIndex: HoprChannels.TicketIndex.wrap(uint64(1)),
  ...
  /**
    ...
    */
  HoprChannels.Ticket public TICKET_AB_WIN_RECYCLED =
    HoprChannels.Ticket({
      channelId: CHANNEL_AB_ID,
      amount: HoprChannels.Balance.wrap(uint96(10)),
      ticketIndex: HoprChannels.TicketIndex.wrap(uint64(1)),
