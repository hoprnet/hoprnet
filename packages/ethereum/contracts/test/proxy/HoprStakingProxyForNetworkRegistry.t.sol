...
contract HoprStakingProxyForNetworkRegistryTest is Test {
  ...
  function _helperAllocateNftAndStake(
    ...
    vm.mockCall(
      stakeContract,
      abi.encodeWithSignature('isNftTypeAndRankRedeemed2(uint256,string,address)', NFT_TYPE[0], NFT_RANK[0], account),
      abi.encode(hasType0Rank0)
    );
    vm.mockCall(
      stakeContract,
      abi.encodeWithSignature('isNftTypeAndRankRedeemed2(uint256,string,address)', NFT_TYPE[0], NFT_RANK[1], account),
      abi.encode(hasType0Rank1)
    );
    vm.mockCall(
      stakeContract,
      abi.encodeWithSignature('isNftTypeAndRankRedeemed2(uint256,string,address)', NFT_TYPE[1], NFT_RANK[0], account),
      abi.encode(hasType1Rank0)
    );
    vm.mockCall(
      stakeContract,
      abi.encodeWithSignature('isNftTypeAndRankRedeemed2(uint256,string,address)', NFT_TYPE[1], NFT_RANK[1], account),
