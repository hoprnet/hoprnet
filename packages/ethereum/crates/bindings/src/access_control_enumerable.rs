...
pub mod access_control_enumerable {
    ...
    #[doc = "AccessControlEnumerable was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    ...
    impl<M> Clone for AccessControlEnumerable<M> {
        fn clone(&self) -> Self {
            AccessControlEnumerable(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for AccessControlEnumerable<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> std::fmt::Debug for AccessControlEnumerable<M> {
    ...
    impl<M: ethers::providers::Middleware> AccessControlEnumerable<M> {
        ...
        pub fn events(
            &self,
        ) -> ethers::contract::builders::Event<M, AccessControlEnumerableEvents> {
    ...
    impl ::std::fmt::Display for AccessControlEnumerableEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                AccessControlEnumerableEvents::RoleAdminChangedFilter(element) => element.fmt(f),
                AccessControlEnumerableEvents::RoleGrantedFilter(element) => element.fmt(f),
                AccessControlEnumerableEvents::RoleRevokedFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ethers::core::abi::AbiDecode for AccessControlEnumerableCalls {
        fn decode(
            ...
            {
                return Ok(AccessControlEnumerableCalls::DefaultAdminRole(decoded));
            }
            if let Ok(decoded) =
                <GetRoleAdminCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AccessControlEnumerableCalls::GetRoleAdmin(decoded));
            }
            if let Ok(decoded) =
                <GetRoleMemberCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AccessControlEnumerableCalls::GetRoleMember(decoded));
            }
            if let Ok(decoded) =
                <GetRoleMemberCountCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AccessControlEnumerableCalls::GetRoleMemberCount(decoded));
            }
            if let Ok(decoded) =
                <GrantRoleCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AccessControlEnumerableCalls::GrantRole(decoded));
            }
            if let Ok(decoded) =
                <HasRoleCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AccessControlEnumerableCalls::HasRole(decoded));
            }
            if let Ok(decoded) =
                <RenounceRoleCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AccessControlEnumerableCalls::RenounceRole(decoded));
            }
            if let Ok(decoded) =
                <RevokeRoleCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AccessControlEnumerableCalls::RevokeRole(decoded));
            }
            if let Ok(decoded) =
                <SupportsInterfaceCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(AccessControlEnumerableCalls::SupportsInterface(decoded));
            }
    ...
    impl ethers::core::abi::AbiEncode for AccessControlEnumerableCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                AccessControlEnumerableCalls::DefaultAdminRole(element) => element.encode(),
                AccessControlEnumerableCalls::GetRoleAdmin(element) => element.encode(),
                AccessControlEnumerableCalls::GetRoleMember(element) => element.encode(),
                AccessControlEnumerableCalls::GetRoleMemberCount(element) => element.encode(),
                AccessControlEnumerableCalls::GrantRole(element) => element.encode(),
                AccessControlEnumerableCalls::HasRole(element) => element.encode(),
                AccessControlEnumerableCalls::RenounceRole(element) => element.encode(),
                AccessControlEnumerableCalls::RevokeRole(element) => element.encode(),
                AccessControlEnumerableCalls::SupportsInterface(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for AccessControlEnumerableCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                AccessControlEnumerableCalls::DefaultAdminRole(element) => element.fmt(f),
                AccessControlEnumerableCalls::GetRoleAdmin(element) => element.fmt(f),
                AccessControlEnumerableCalls::GetRoleMember(element) => element.fmt(f),
                AccessControlEnumerableCalls::GetRoleMemberCount(element) => element.fmt(f),
                AccessControlEnumerableCalls::GrantRole(element) => element.fmt(f),
                AccessControlEnumerableCalls::HasRole(element) => element.fmt(f),
                AccessControlEnumerableCalls::RenounceRole(element) => element.fmt(f),
                AccessControlEnumerableCalls::RevokeRole(element) => element.fmt(f),
                AccessControlEnumerableCalls::SupportsInterface(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<DefaultAdminRoleCall> for AccessControlEnumerableCalls {
        fn from(var: DefaultAdminRoleCall) -> Self {
            AccessControlEnumerableCalls::DefaultAdminRole(var)
        }
    }
    impl ::std::convert::From<GetRoleAdminCall> for AccessControlEnumerableCalls {
        fn from(var: GetRoleAdminCall) -> Self {
            AccessControlEnumerableCalls::GetRoleAdmin(var)
        }
    }
    impl ::std::convert::From<GetRoleMemberCall> for AccessControlEnumerableCalls {
        fn from(var: GetRoleMemberCall) -> Self {
            AccessControlEnumerableCalls::GetRoleMember(var)
        }
    }
    impl ::std::convert::From<GetRoleMemberCountCall> for AccessControlEnumerableCalls {
        fn from(var: GetRoleMemberCountCall) -> Self {
            AccessControlEnumerableCalls::GetRoleMemberCount(var)
        }
    }
    impl ::std::convert::From<GrantRoleCall> for AccessControlEnumerableCalls {
        fn from(var: GrantRoleCall) -> Self {
            AccessControlEnumerableCalls::GrantRole(var)
        }
    }
    impl ::std::convert::From<HasRoleCall> for AccessControlEnumerableCalls {
        fn from(var: HasRoleCall) -> Self {
            AccessControlEnumerableCalls::HasRole(var)
        }
    }
    impl ::std::convert::From<RenounceRoleCall> for AccessControlEnumerableCalls {
        fn from(var: RenounceRoleCall) -> Self {
            AccessControlEnumerableCalls::RenounceRole(var)
        }
    }
    impl ::std::convert::From<RevokeRoleCall> for AccessControlEnumerableCalls {
        fn from(var: RevokeRoleCall) -> Self {
            AccessControlEnumerableCalls::RevokeRole(var)
        }
    }
    impl ::std::convert::From<SupportsInterfaceCall> for AccessControlEnumerableCalls {
        fn from(var: SupportsInterfaceCall) -> Self {
            AccessControlEnumerableCalls::SupportsInterface(var)
        }
    }
