...
pub mod hopr_stake_season_7 {
    ...
    pub static HOPRSTAKESEASON7_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static HOPRSTAKESEASON7_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
        ::ethers::core::types::Bytes::from_static(__DEPLOYED_BYTECODE);
    pub struct HoprStakeSeason7<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for HoprStakeSeason7<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for HoprStakeSeason7<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for HoprStakeSeason7<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for HoprStakeSeason7<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(HoprStakeSeason7))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> HoprStakeSeason7<M> {
        /// Creates a new contract instance with the specified `ethers` client at
        /// `address`. The contract derefs to a `ethers::Contract` object.
        pub fn new<T: Into<::ethers::core::types::Address>>(address: T, client: ::std::sync::Arc<M>) -> Self {
            Self(::ethers::contract::Contract::new(
                address.into(),
                HOPRSTAKESEASON7_ABI.clone(),
                client,
            ))
        }
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                HOPRSTAKESEASON7_ABI.clone(),
                HOPRSTAKESEASON7_BYTECODE.clone().into(),
                client,
            );
        ...
        ///Calls the contract's `ownerBatchBlockNftType` (0x33bd64ca) function
        pub fn owner_batch_block_nft_type(
            &self,
            type_indexes: ::std::vec::Vec<::ethers::core::types::U256>,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([51, 189, 100, 202], type_indexes)
                .expect("method not found (this should never happen)")
        }
        ///Calls the contract's `ownerBatchUnblockNftType` (0x812339a3) function
        pub fn owner_batch_unblock_nft_type(
            &self,
            type_indexes: ::std::vec::Vec<::ethers::core::types::U256>,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([129, 35, 57, 163], type_indexes)
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, HoprStakeSeason7Events> {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for HoprStakeSeason7<M> {
    ...
    pub enum HoprStakeSeason7Events {
    ...
    impl ::ethers::contract::EthLogDecode for HoprStakeSeason7Events {
        fn decode_log(log: &::ethers::core::abi::RawLog) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ClaimedFilter::decode_log(log) {
                return Ok(HoprStakeSeason7Events::ClaimedFilter(decoded));
            }
            if let Ok(decoded) = NftAllowedFilter::decode_log(log) {
                return Ok(HoprStakeSeason7Events::NftAllowedFilter(decoded));
            }
            if let Ok(decoded) = NftBlockedFilter::decode_log(log) {
                return Ok(HoprStakeSeason7Events::NftBlockedFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(HoprStakeSeason7Events::OwnershipTransferredFilter(decoded));
            }
            if let Ok(decoded) = RedeemedFilter::decode_log(log) {
                return Ok(HoprStakeSeason7Events::RedeemedFilter(decoded));
            }
            if let Ok(decoded) = ReleasedFilter::decode_log(log) {
                return Ok(HoprStakeSeason7Events::ReleasedFilter(decoded));
            }
            if let Ok(decoded) = RewardFueledFilter::decode_log(log) {
                return Ok(HoprStakeSeason7Events::RewardFueledFilter(decoded));
            }
            if let Ok(decoded) = StakedFilter::decode_log(log) {
                return Ok(HoprStakeSeason7Events::StakedFilter(decoded));
            }
            if let Ok(decoded) = SyncFilter::decode_log(log) {
                return Ok(HoprStakeSeason7Events::SyncFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for HoprStakeSeason7Events {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ClaimedFilter> for HoprStakeSeason7Events {
        fn from(value: ClaimedFilter) -> Self {
            Self::ClaimedFilter(value)
        }
    }
    impl ::core::convert::From<NftAllowedFilter> for HoprStakeSeason7Events {
        fn from(value: NftAllowedFilter) -> Self {
            Self::NftAllowedFilter(value)
        }
    }
    impl ::core::convert::From<NftBlockedFilter> for HoprStakeSeason7Events {
        fn from(value: NftBlockedFilter) -> Self {
            Self::NftBlockedFilter(value)
        }
    }
    impl ::core::convert::From<OwnershipTransferredFilter> for HoprStakeSeason7Events {
        fn from(value: OwnershipTransferredFilter) -> Self {
            Self::OwnershipTransferredFilter(value)
        }
    }
    impl ::core::convert::From<RedeemedFilter> for HoprStakeSeason7Events {
        fn from(value: RedeemedFilter) -> Self {
            Self::RedeemedFilter(value)
        }
    }
    impl ::core::convert::From<ReleasedFilter> for HoprStakeSeason7Events {
        fn from(value: ReleasedFilter) -> Self {
            Self::ReleasedFilter(value)
        }
    }
    impl ::core::convert::From<RewardFueledFilter> for HoprStakeSeason7Events {
        fn from(value: RewardFueledFilter) -> Self {
            Self::RewardFueledFilter(value)
        }
    }
    impl ::core::convert::From<StakedFilter> for HoprStakeSeason7Events {
        fn from(value: StakedFilter) -> Self {
            Self::StakedFilter(value)
        }
    }
    impl ::core::convert::From<SyncFilter> for HoprStakeSeason7Events {
    ...
    ///Container type for all input parameters for the `ownerBatchBlockNftType` function with signature `ownerBatchBlockNftType(uint256[])` and selector `0x33bd64ca`
    #[derive(
        Clone, ::ethers::contract::EthCall, ::ethers::contract::EthDisplay, Default, Debug, PartialEq, Eq, Hash,
    )]
    #[ethcall(name = "ownerBatchBlockNftType", abi = "ownerBatchBlockNftType(uint256[])")]
    pub struct OwnerBatchBlockNftTypeCall {
        pub type_indexes: ::std::vec::Vec<::ethers::core::types::U256>,
    }
    ///Container type for all input parameters for the `ownerBatchUnblockNftType` function with signature `ownerBatchUnblockNftType(uint256[])` and selector `0x812339a3`
    #[derive(
        Clone, ::ethers::contract::EthCall, ::ethers::contract::EthDisplay, Default, Debug, PartialEq, Eq, Hash,
    )]
    #[ethcall(name = "ownerBatchUnblockNftType", abi = "ownerBatchUnblockNftType(uint256[])")]
    pub struct OwnerBatchUnblockNftTypeCall {
        pub type_indexes: ::std::vec::Vec<::ethers::core::types::U256>,
    }
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum HoprStakeSeason7Calls {
        ...
        Owner(OwnerCall),
        OwnerBatchBlockNftType(OwnerBatchBlockNftTypeCall),
        OwnerBatchUnblockNftType(OwnerBatchUnblockNftTypeCall),
    ...
    impl ::ethers::core::abi::AbiDecode for HoprStakeSeason7Calls {
        fn decode(data: impl AsRef<[u8]>) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            ...
            if let Ok(decoded) = <BatchStakeForCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::BatchStakeFor(decoded));
            }
            ...
            if let Ok(decoded) = <OwnerBatchBlockNftTypeCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::OwnerBatchBlockNftType(decoded));
            }
            if let Ok(decoded) = <OwnerBatchUnblockNftTypeCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::OwnerBatchUnblockNftType(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for HoprStakeSeason7Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::BatchStakeFor(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::OwnerBatchBlockNftType(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::OwnerBatchUnblockNftType(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::fmt::Display for HoprStakeSeason7Calls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::BatchStakeFor(element) => ::core::fmt::Display::fmt(element, f),
                ...
                Self::OwnerBatchBlockNftType(element) => ::core::fmt::Display::fmt(element, f),
                Self::OwnerBatchUnblockNftType(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<BasicFactorNumeratorCall> for HoprStakeSeason7Calls {
        fn from(value: BasicFactorNumeratorCall) -> Self {
            Self::BasicFactorNumerator(value)
        }
    }
    impl ::core::convert::From<BoostCapCall> for HoprStakeSeason7Calls {
        fn from(value: BoostCapCall) -> Self {
            Self::BoostCap(value)
        }
    }
    impl ::core::convert::From<FactorDenominatorCall> for HoprStakeSeason7Calls {
        fn from(value: FactorDenominatorCall) -> Self {
            Self::FactorDenominator(value)
        }
    }
    impl ::core::convert::From<LockTokenCall> for HoprStakeSeason7Calls {
        fn from(value: LockTokenCall) -> Self {
            Self::LockToken(value)
        }
    }
    impl ::core::convert::From<NftContractCall> for HoprStakeSeason7Calls {
        fn from(value: NftContractCall) -> Self {
            Self::NftContract(value)
        }
    }
    impl ::core::convert::From<ProgramEndCall> for HoprStakeSeason7Calls {
        fn from(value: ProgramEndCall) -> Self {
            Self::ProgramEnd(value)
        }
    }
    impl ::core::convert::From<ProgramStartCall> for HoprStakeSeason7Calls {
        fn from(value: ProgramStartCall) -> Self {
            Self::ProgramStart(value)
        }
    }
    impl ::core::convert::From<RewardTokenCall> for HoprStakeSeason7Calls {
        fn from(value: RewardTokenCall) -> Self {
            Self::RewardToken(value)
        }
    }
    impl ::core::convert::From<AccountsCall> for HoprStakeSeason7Calls {
        fn from(value: AccountsCall) -> Self {
            Self::Accounts(value)
        }
    }
    impl ::core::convert::From<AvailableRewardCall> for HoprStakeSeason7Calls {
        fn from(value: AvailableRewardCall) -> Self {
            Self::AvailableReward(value)
        }
    }
    impl ::core::convert::From<BatchStakeForCall> for HoprStakeSeason7Calls {
        fn from(value: BatchStakeForCall) -> Self {
            Self::BatchStakeFor(value)
        }
    }
    impl ::core::convert::From<ClaimRewardsCall> for HoprStakeSeason7Calls {
        fn from(value: ClaimRewardsCall) -> Self {
            Self::ClaimRewards(value)
        }
    }
    impl ::core::convert::From<GetCumulatedRewardsIncrementCall> for HoprStakeSeason7Calls {
        fn from(value: GetCumulatedRewardsIncrementCall) -> Self {
            Self::GetCumulatedRewardsIncrement(value)
        }
    }
    impl ::core::convert::From<IsBlockedNftCall> for HoprStakeSeason7Calls {
        fn from(value: IsBlockedNftCall) -> Self {
            Self::IsBlockedNft(value)
        }
    }
    impl ::core::convert::From<IsNftTypeAndRankRedeemed1Call> for HoprStakeSeason7Calls {
        fn from(value: IsNftTypeAndRankRedeemed1Call) -> Self {
            Self::IsNftTypeAndRankRedeemed1(value)
        }
    }
    impl ::core::convert::From<IsNftTypeAndRankRedeemed2Call> for HoprStakeSeason7Calls {
        fn from(value: IsNftTypeAndRankRedeemed2Call) -> Self {
            Self::IsNftTypeAndRankRedeemed2(value)
        }
    }
    impl ::core::convert::From<IsNftTypeAndRankRedeemed3Call> for HoprStakeSeason7Calls {
        fn from(value: IsNftTypeAndRankRedeemed3Call) -> Self {
            Self::IsNftTypeAndRankRedeemed3(value)
        }
    }
    impl ::core::convert::From<IsNftTypeAndRankRedeemed4Call> for HoprStakeSeason7Calls {
        fn from(value: IsNftTypeAndRankRedeemed4Call) -> Self {
            Self::IsNftTypeAndRankRedeemed4(value)
        }
    }
    impl ::core::convert::From<OnERC721ReceivedCall> for HoprStakeSeason7Calls {
        fn from(value: OnERC721ReceivedCall) -> Self {
            Self::OnERC721Received(value)
        }
    }
    impl ::core::convert::From<OnTokenTransferCall> for HoprStakeSeason7Calls {
        fn from(value: OnTokenTransferCall) -> Self {
            Self::OnTokenTransfer(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for HoprStakeSeason7Calls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<OwnerBatchBlockNftTypeCall> for HoprStakeSeason7Calls {
        fn from(value: OwnerBatchBlockNftTypeCall) -> Self {
            Self::OwnerBatchBlockNftType(value)
        }
    }
    impl ::core::convert::From<OwnerBatchUnblockNftTypeCall> for HoprStakeSeason7Calls {
        fn from(value: OwnerBatchUnblockNftTypeCall) -> Self {
            Self::OwnerBatchUnblockNftType(value)
        }
    }
    impl ::core::convert::From<OwnerBlockNftTypeCall> for HoprStakeSeason7Calls {
        fn from(value: OwnerBlockNftTypeCall) -> Self {
            Self::OwnerBlockNftType(value)
        }
    }
    impl ::core::convert::From<OwnerUnblockNftTypeCall> for HoprStakeSeason7Calls {
        fn from(value: OwnerUnblockNftTypeCall) -> Self {
            Self::OwnerUnblockNftType(value)
        }
    }
    impl ::core::convert::From<ReclaimErc20TokensCall> for HoprStakeSeason7Calls {
        fn from(value: ReclaimErc20TokensCall) -> Self {
            Self::ReclaimErc20Tokens(value)
        }
    }
    impl ::core::convert::From<ReclaimErc721TokensCall> for HoprStakeSeason7Calls {
        fn from(value: ReclaimErc721TokensCall) -> Self {
            Self::ReclaimErc721Tokens(value)
        }
    }
    impl ::core::convert::From<RedeemedFactorCall> for HoprStakeSeason7Calls {
        fn from(value: RedeemedFactorCall) -> Self {
            Self::RedeemedFactor(value)
        }
    }
    impl ::core::convert::From<RedeemedFactorIndexCall> for HoprStakeSeason7Calls {
        fn from(value: RedeemedFactorIndexCall) -> Self {
            Self::RedeemedFactorIndex(value)
        }
    }
    impl ::core::convert::From<RedeemedNftCall> for HoprStakeSeason7Calls {
        fn from(value: RedeemedNftCall) -> Self {
            Self::RedeemedNft(value)
        }
    }
    impl ::core::convert::From<RedeemedNftIndexCall> for HoprStakeSeason7Calls {
        fn from(value: RedeemedNftIndexCall) -> Self {
            Self::RedeemedNftIndex(value)
        }
    }
    impl ::core::convert::From<RenounceOwnershipCall> for HoprStakeSeason7Calls {
        fn from(value: RenounceOwnershipCall) -> Self {
            Self::RenounceOwnership(value)
        }
    }
    impl ::core::convert::From<StakedHoprTokensCall> for HoprStakeSeason7Calls {
        fn from(value: StakedHoprTokensCall) -> Self {
            Self::StakedHoprTokens(value)
        }
    }
    impl ::core::convert::From<SyncCall> for HoprStakeSeason7Calls {
        fn from(value: SyncCall) -> Self {
            Self::Sync(value)
        }
    }
    impl ::core::convert::From<TokensReceivedCall> for HoprStakeSeason7Calls {
        fn from(value: TokensReceivedCall) -> Self {
            Self::TokensReceived(value)
        }
    }
    impl ::core::convert::From<TotalLockedCall> for HoprStakeSeason7Calls {
        fn from(value: TotalLockedCall) -> Self {
            Self::TotalLocked(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for HoprStakeSeason7Calls {
        fn from(value: TransferOwnershipCall) -> Self {
            Self::TransferOwnership(value)
        }
    }
    impl ::core::convert::From<UnlockCall> for HoprStakeSeason7Calls {
        fn from(value: UnlockCall) -> Self {
            Self::Unlock(value)
        }
    }
    impl ::core::convert::From<UnlockForCall> for HoprStakeSeason7Calls {
