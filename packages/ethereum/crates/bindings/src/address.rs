...
pub mod address {
    ...
    pub static ADDRESS_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "0x604c602c600b82828239805160001a60731460008114601c57601e565bfe5b5030600052607381538281f30073000000000000000000000000000000000000000030146080604052600080fd00a165627a7a7230582017b238af4d5df6ec1d5b642d8ce0e468ce5e557d593cbfe1c93b6cf81b37830c0029" . parse () . expect ("invalid bytecode")
        });
