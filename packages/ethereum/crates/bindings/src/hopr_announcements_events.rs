...
pub mod hopr_announcements_events {
    ...
    pub static HOPRANNOUNCEMENTSEVENTS_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> HoprAnnouncementsEvents<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, HoprAnnouncementsEventsEvents> {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for HoprAnnouncementsEvents<M> {
    ...
    impl ::ethers::contract::EthLogDecode for HoprAnnouncementsEventsEvents {
        fn decode_log(log: &::ethers::core::abi::RawLog) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = AddressAnnouncementFilter::decode_log(log) {
                return Ok(HoprAnnouncementsEventsEvents::AddressAnnouncementFilter(decoded));
            }
            ...
            if let Ok(decoded) = RevokeAnnouncementFilter::decode_log(log) {
                return Ok(HoprAnnouncementsEventsEvents::RevokeAnnouncementFilter(decoded));
            }
    ...
    impl ::core::convert::From<AddressAnnouncementFilter> for HoprAnnouncementsEventsEvents {
    ...
    impl ::core::convert::From<RevokeAnnouncementFilter> for HoprAnnouncementsEventsEvents {
