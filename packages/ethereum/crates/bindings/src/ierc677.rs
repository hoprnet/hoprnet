...
pub mod ierc677 {
    ...
    impl<M: ethers::providers::Middleware> IERC677<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), IERC677_ABI.clone(), client).into()
        }
        ...
        pub fn events(&self) -> ethers::contract::builders::Event<M, IERC677Events> {
            self.0.event_with_filter(Default::default())
        }
    }
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for IERC677<M> {
    ...
    pub enum IERC677Events {
        ApprovalFilter(ApprovalFilter),
        Transfer1Filter(Transfer1Filter),
        Transfer2Filter(Transfer2Filter),
    }
    impl ethers::contract::EthLogDecode for IERC677Events {
        fn decode_log(
            ...
            Self: Sized,
        {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(IERC677Events::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = Transfer1Filter::decode_log(log) {
                return Ok(IERC677Events::Transfer1Filter(decoded));
            }
            if let Ok(decoded) = Transfer2Filter::decode_log(log) {
                return Ok(IERC677Events::Transfer2Filter(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::std::fmt::Display for IERC677Events {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                IERC677Events::ApprovalFilter(element) => element.fmt(f),
                IERC677Events::Transfer1Filter(element) => element.fmt(f),
                IERC677Events::Transfer2Filter(element) => element.fmt(f),
            }
        }
    }
    ...
    impl ethers::core::abi::AbiDecode for IERC677Calls {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            {
                return Ok(IERC677Calls::Allowance(decoded));
            }
            if let Ok(decoded) =
                <ApproveCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IERC677Calls::Approve(decoded));
            }
            if let Ok(decoded) =
                <BalanceOfCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IERC677Calls::BalanceOf(decoded));
            }
            if let Ok(decoded) =
                <DecreaseAllowanceCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IERC677Calls::DecreaseAllowance(decoded));
            }
            if let Ok(decoded) =
                <IncreaseAllowanceCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IERC677Calls::IncreaseAllowance(decoded));
            }
            if let Ok(decoded) =
                <TotalSupplyCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IERC677Calls::TotalSupply(decoded));
            }
            if let Ok(decoded) =
                <TransferCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IERC677Calls::Transfer(decoded));
            }
            if let Ok(decoded) =
                <TransferAndCallCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IERC677Calls::TransferAndCall(decoded));
            }
            if let Ok(decoded) =
                <TransferFromCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IERC677Calls::TransferFrom(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for IERC677Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                IERC677Calls::Allowance(element) => element.encode(),
                IERC677Calls::Approve(element) => element.encode(),
                IERC677Calls::BalanceOf(element) => element.encode(),
                IERC677Calls::DecreaseAllowance(element) => element.encode(),
                IERC677Calls::IncreaseAllowance(element) => element.encode(),
                IERC677Calls::TotalSupply(element) => element.encode(),
                IERC677Calls::Transfer(element) => element.encode(),
                IERC677Calls::TransferAndCall(element) => element.encode(),
                IERC677Calls::TransferFrom(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for IERC677Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                IERC677Calls::Allowance(element) => element.fmt(f),
                IERC677Calls::Approve(element) => element.fmt(f),
                IERC677Calls::BalanceOf(element) => element.fmt(f),
                IERC677Calls::DecreaseAllowance(element) => element.fmt(f),
                IERC677Calls::IncreaseAllowance(element) => element.fmt(f),
                IERC677Calls::TotalSupply(element) => element.fmt(f),
                IERC677Calls::Transfer(element) => element.fmt(f),
                IERC677Calls::TransferAndCall(element) => element.fmt(f),
                IERC677Calls::TransferFrom(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<AllowanceCall> for IERC677Calls {
        fn from(var: AllowanceCall) -> Self {
            IERC677Calls::Allowance(var)
        }
    }
    impl ::std::convert::From<ApproveCall> for IERC677Calls {
        fn from(var: ApproveCall) -> Self {
            IERC677Calls::Approve(var)
        }
    }
    impl ::std::convert::From<BalanceOfCall> for IERC677Calls {
        fn from(var: BalanceOfCall) -> Self {
            IERC677Calls::BalanceOf(var)
        }
    }
    impl ::std::convert::From<DecreaseAllowanceCall> for IERC677Calls {
        fn from(var: DecreaseAllowanceCall) -> Self {
            IERC677Calls::DecreaseAllowance(var)
        }
    }
    impl ::std::convert::From<IncreaseAllowanceCall> for IERC677Calls {
        fn from(var: IncreaseAllowanceCall) -> Self {
            IERC677Calls::IncreaseAllowance(var)
        }
    }
    impl ::std::convert::From<TotalSupplyCall> for IERC677Calls {
        fn from(var: TotalSupplyCall) -> Self {
            IERC677Calls::TotalSupply(var)
        }
    }
    impl ::std::convert::From<TransferCall> for IERC677Calls {
        fn from(var: TransferCall) -> Self {
            IERC677Calls::Transfer(var)
        }
    }
    impl ::std::convert::From<TransferAndCallCall> for IERC677Calls {
        fn from(var: TransferAndCallCall) -> Self {
            IERC677Calls::TransferAndCall(var)
        }
    }
    impl ::std::convert::From<TransferFromCall> for IERC677Calls {
        fn from(var: TransferFromCall) -> Self {
            IERC677Calls::TransferFrom(var)
        }
    }
