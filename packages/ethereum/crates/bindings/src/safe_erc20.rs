...
pub mod safe_erc20 {
    ...
    pub static SAFEERC20_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "0x604c602c600b82828239805160001a60731460008114601c57601e565bfe5b5030600052607381538281f30073000000000000000000000000000000000000000030146080604052600080fd00a165627a7a72305820ae0a6a990ad7582e9f64e8016b2227b3d8bdf1c2460b2efd62a233e586993baa0029" . parse () . expect ("invalid bytecode")
        });
