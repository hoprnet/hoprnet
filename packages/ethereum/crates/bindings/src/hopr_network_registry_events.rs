...
pub mod hopr_network_registry_events {
    ...
    pub static HOPRNETWORKREGISTRYEVENTS_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> HoprNetworkRegistryEvents<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, HoprNetworkRegistryEventsEvents> {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for HoprNetworkRegistryEvents<M> {
    ...
    impl ::ethers::contract::EthLogDecode for HoprNetworkRegistryEventsEvents {
        fn decode_log(log: &::ethers::core::abi::RawLog) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            ...
            if let Ok(decoded) = DeregisteredByManagerFilter::decode_log(log) {
                return Ok(HoprNetworkRegistryEventsEvents::DeregisteredByManagerFilter(decoded));
            }
            if let Ok(decoded) = EligibilityUpdatedFilter::decode_log(log) {
                return Ok(HoprNetworkRegistryEventsEvents::EligibilityUpdatedFilter(decoded));
            }
            if let Ok(decoded) = NetworkRegistryStatusUpdatedFilter::decode_log(log) {
                return Ok(HoprNetworkRegistryEventsEvents::NetworkRegistryStatusUpdatedFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = RegisteredByManagerFilter::decode_log(log) {
                return Ok(HoprNetworkRegistryEventsEvents::RegisteredByManagerFilter(decoded));
            }
            if let Ok(decoded) = RequirementUpdatedFilter::decode_log(log) {
                return Ok(HoprNetworkRegistryEventsEvents::RequirementUpdatedFilter(decoded));
            }
    ...
    impl ::core::convert::From<DeregisteredByManagerFilter> for HoprNetworkRegistryEventsEvents {
        fn from(value: DeregisteredByManagerFilter) -> Self {
            Self::DeregisteredByManagerFilter(value)
        }
    }
    impl ::core::convert::From<EligibilityUpdatedFilter> for HoprNetworkRegistryEventsEvents {
        fn from(value: EligibilityUpdatedFilter) -> Self {
            Self::EligibilityUpdatedFilter(value)
        }
    }
    impl ::core::convert::From<NetworkRegistryStatusUpdatedFilter> for HoprNetworkRegistryEventsEvents {
    ...
    impl ::core::convert::From<RegisteredByManagerFilter> for HoprNetworkRegistryEventsEvents {
        fn from(value: RegisteredByManagerFilter) -> Self {
            Self::RegisteredByManagerFilter(value)
        }
    }
    impl ::core::convert::From<RequirementUpdatedFilter> for HoprNetworkRegistryEventsEvents {
