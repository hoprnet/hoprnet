...
pub mod hopr_node_safe_registry {
    ...
    pub enum HoprNodeSafeRegistryErrors {
        ...
        NotSafeOwnerNorNode(NotSafeOwnerNorNode),
    ...
    impl ::core::convert::From<NotSafeOwnerNorNode> for HoprNodeSafeRegistryErrors {
        fn from(value: NotSafeOwnerNorNode) -> Self {
            Self::NotSafeOwnerNorNode(value)
        }
    }
