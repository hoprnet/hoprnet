...
pub mod hopr_node_safe_registry {
    ...
    impl<M: ::ethers::providers::Middleware> HoprNodeSafeRegistry<M> {
        ...
        ///Calls the contract's `isNodeSafeRegistered` (0x37480abd) function
        pub fn is_node_safe_registered(
            &self,
            safe_address: ::ethers::core::types::Address,
            node_chain_key_address: ::ethers::core::types::Address,
        ) -> ::ethers::contract::builders::ContractCall<M, bool> {
            self.0
                .method_hash([55, 72, 10, 189], (safe_address, node_chain_key_address))
                .expect("method not found (this should never happen)")
        }
        ...
        ///Calls the contract's `registerSafeWithNodeSig` (0x49d215e1) function
        pub fn register_safe_with_node_sig(
            ...
            self.0
                .method_hash(
                    [73, 210, 21, 225],
                    (safe_address, node_chain_key_address, sig),
                )
                .expect("method not found (this should never happen)")
        }
    ...
    impl ::ethers::contract::EthLogDecode for HoprNodeSafeRegistryEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = DomainSeparatorUpdatedFilter::decode_log(log) {
                return Ok(
                    HoprNodeSafeRegistryEvents::DomainSeparatorUpdatedFilter(decoded),
                );
            }
