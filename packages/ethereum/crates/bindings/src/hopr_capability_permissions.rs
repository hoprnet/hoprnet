...
pub mod hopr_capability_permissions {
    ...
    pub static HOPRCAPABILITYPERMISSIONS_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static HOPRCAPABILITYPERMISSIONS_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static HOPRCAPABILITYPERMISSIONS_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M: ::ethers::providers::Middleware> HoprCapabilityPermissions<M> {
        ...
        pub fn revoked_target_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, RevokedTargetFilter> {
            self.0.event()
        }
        ///Gets the contract's `ScopedGranularChannelCapability` event
        pub fn scoped_granular_channel_capability_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ScopedGranularChannelCapabilityFilter>
        {
            self.0.event()
        }
        ...
        pub fn scoped_granular_send_capability_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ScopedGranularSendCapabilityFilter> {
            self.0.event()
        }
        ///Gets the contract's `ScopedGranularTokenCapability` event
        pub fn scoped_granular_token_capability_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ScopedGranularTokenCapabilityFilter> {
            self.0.event()
        }
        ///Gets the contract's `ScopedTargetChannels` event
        pub fn scoped_target_channels_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ScopedTargetChannelsFilter> {
            self.0.event()
        }
        ///Gets the contract's `ScopedTargetSend` event
        pub fn scoped_target_send_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ScopedTargetSendFilter> {
            self.0.event()
        }
        ///Gets the contract's `ScopedTargetToken` event
        pub fn scoped_target_token_filter(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ScopedTargetTokenFilter> {
            self.0.event()
        }
        /// Returns an `Event` builder for all the events of this contract.
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, HoprCapabilityPermissionsEvents> {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for HoprCapabilityPermissions<M> {
    ...
    impl ::core::convert::From<::std::string::String> for HoprCapabilityPermissionsErrors {
    ...
    impl ::core::convert::From<ArraysDifferentLength> for HoprCapabilityPermissionsErrors {
    ...
    impl ::core::convert::From<DefaultPermissionRejected> for HoprCapabilityPermissionsErrors {
        fn from(value: DefaultPermissionRejected) -> Self {
            Self::DefaultPermissionRejected(value)
        }
    }
    impl ::core::convert::From<DelegateCallNotAllowed> for HoprCapabilityPermissionsErrors {
        fn from(value: DelegateCallNotAllowed) -> Self {
            Self::DelegateCallNotAllowed(value)
        }
    }
    impl ::core::convert::From<FunctionSignatureTooShort> for HoprCapabilityPermissionsErrors {
        fn from(value: FunctionSignatureTooShort) -> Self {
            Self::FunctionSignatureTooShort(value)
        }
    }
    impl ::core::convert::From<GranularPermissionRejected> for HoprCapabilityPermissionsErrors {
    ...
    impl ::core::convert::From<NodePermissionRejected> for HoprCapabilityPermissionsErrors {
    ...
    impl ::core::convert::From<PermissionNotConfigured> for HoprCapabilityPermissionsErrors {
    ...
    impl ::core::convert::From<TargetAddressNotAllowed> for HoprCapabilityPermissionsErrors {
    ...
    impl ::core::convert::From<UnacceptableMultiSendOffset> for HoprCapabilityPermissionsErrors {
    ...
    #[ethevent(name = "ScopedTargetChannels", abi = "ScopedTargetChannels(address,uint256)")]
    ...
    impl ::ethers::contract::EthLogDecode for HoprCapabilityPermissionsEvents {
        fn decode_log(log: &::ethers::core::abi::RawLog) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            ...
            if let Ok(decoded) = ScopedGranularChannelCapabilityFilter::decode_log(log) {
                return Ok(HoprCapabilityPermissionsEvents::ScopedGranularChannelCapabilityFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = ScopedGranularSendCapabilityFilter::decode_log(log) {
                return Ok(HoprCapabilityPermissionsEvents::ScopedGranularSendCapabilityFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = ScopedGranularTokenCapabilityFilter::decode_log(log) {
                return Ok(HoprCapabilityPermissionsEvents::ScopedGranularTokenCapabilityFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = ScopedTargetChannelsFilter::decode_log(log) {
                return Ok(HoprCapabilityPermissionsEvents::ScopedTargetChannelsFilter(decoded));
            }
            if let Ok(decoded) = ScopedTargetSendFilter::decode_log(log) {
                return Ok(HoprCapabilityPermissionsEvents::ScopedTargetSendFilter(decoded));
            }
            if let Ok(decoded) = ScopedTargetTokenFilter::decode_log(log) {
                return Ok(HoprCapabilityPermissionsEvents::ScopedTargetTokenFilter(decoded));
            }
    ...
    impl ::core::fmt::Display for HoprCapabilityPermissionsEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::RevokedTargetFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::ScopedGranularChannelCapabilityFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::ScopedGranularSendCapabilityFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::ScopedGranularTokenCapabilityFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::ScopedTargetChannelsFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::ScopedTargetSendFilter(element) => ::core::fmt::Display::fmt(element, f),
                Self::ScopedTargetTokenFilter(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    ...
    impl ::core::convert::From<ScopedGranularChannelCapabilityFilter> for HoprCapabilityPermissionsEvents {
        fn from(value: ScopedGranularChannelCapabilityFilter) -> Self {
            Self::ScopedGranularChannelCapabilityFilter(value)
        }
    }
    impl ::core::convert::From<ScopedGranularSendCapabilityFilter> for HoprCapabilityPermissionsEvents {
        fn from(value: ScopedGranularSendCapabilityFilter) -> Self {
            Self::ScopedGranularSendCapabilityFilter(value)
        }
    }
    impl ::core::convert::From<ScopedGranularTokenCapabilityFilter> for HoprCapabilityPermissionsEvents {
        fn from(value: ScopedGranularTokenCapabilityFilter) -> Self {
            Self::ScopedGranularTokenCapabilityFilter(value)
        }
    }
    impl ::core::convert::From<ScopedTargetChannelsFilter> for HoprCapabilityPermissionsEvents {
        fn from(value: ScopedTargetChannelsFilter) -> Self {
            Self::ScopedTargetChannelsFilter(value)
        }
    }
    impl ::core::convert::From<ScopedTargetSendFilter> for HoprCapabilityPermissionsEvents {
        fn from(value: ScopedTargetSendFilter) -> Self {
            Self::ScopedTargetSendFilter(value)
        }
    }
    impl ::core::convert::From<ScopedTargetTokenFilter> for HoprCapabilityPermissionsEvents {
