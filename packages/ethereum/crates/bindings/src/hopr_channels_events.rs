...
pub mod hopr_channels_events {
    ...
    pub static HOPRCHANNELSEVENTS_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M> ::core::fmt::Debug for HoprChannelsEvents<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(HoprChannelsEvents))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> HoprChannelsEvents<M> {
        ...
        pub fn events(&self) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, HoprChannelsEventsEvents> {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for HoprChannelsEvents<M> {
    ...
    impl ::ethers::contract::EthLogDecode for HoprChannelsEventsEvents {
        fn decode_log(log: &::ethers::core::abi::RawLog) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ChannelBalanceDecreasedFilter::decode_log(log) {
                return Ok(HoprChannelsEventsEvents::ChannelBalanceDecreasedFilter(decoded));
            }
            if let Ok(decoded) = ChannelBalanceIncreasedFilter::decode_log(log) {
                return Ok(HoprChannelsEventsEvents::ChannelBalanceIncreasedFilter(decoded));
            }
            ...
            if let Ok(decoded) = OutgoingChannelClosureInitiatedFilter::decode_log(log) {
                return Ok(HoprChannelsEventsEvents::OutgoingChannelClosureInitiatedFilter(decoded));
            }
    ...
    impl ::core::convert::From<ChannelBalanceDecreasedFilter> for HoprChannelsEventsEvents {
        fn from(value: ChannelBalanceDecreasedFilter) -> Self {
            Self::ChannelBalanceDecreasedFilter(value)
        }
    }
    impl ::core::convert::From<ChannelBalanceIncreasedFilter> for HoprChannelsEventsEvents {
    ...
    impl ::core::convert::From<OutgoingChannelClosureInitiatedFilter> for HoprChannelsEventsEvents {
