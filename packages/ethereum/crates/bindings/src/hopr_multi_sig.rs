...
pub mod hopr_multi_sig {
    ...
    pub static HOPRMULTISIG_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for HoprMultiSig<M> {
