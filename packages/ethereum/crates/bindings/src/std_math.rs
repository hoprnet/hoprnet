...
pub mod std_math {
    ...
    pub static STDMATH_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "0x60566023600b82828239805160001a607314601657fe5b30600052607381538281f3fe73000000000000000000000000000000000000000030146080604052600080fdfea2646970667358221220f1c456d3310ff125cda6657ca88ac5094974bf03084f7ecebd7bb8a8d57a005064736f6c634300060c0033" . parse () . expect ("invalid bytecode")
        });
