...
pub mod safe_math {
    ...
    pub static SAFEMATH_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "0x604c602c600b82828239805160001a60731460008114601c57601e565bfe5b5030600052607381538281f30073000000000000000000000000000000000000000030146080604052600080fd00a165627a7a72305820879296625d9ed85a21035df5d3b210a10d76f155c960243e9caaeef8b6e3fdc30029" . parse () . expect ("invalid bytecode")
        });
