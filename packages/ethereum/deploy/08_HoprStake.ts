...
const main: DeployFunction = async function ({
    ethers, deployments, network, getNamedAccounts, environment
  ...
  const xHOPR = (network.tags.testing || network.tags.development) ? await deployments.get("xHoprMock") : environmentConfig['minted_token_receiver_address'];
