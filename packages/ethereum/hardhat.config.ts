...
task<FaucetCLIOPts>('faucet', 'Faucets a local development HOPR node account with ETH and HOPR tokens', faucet)
  ...
  .addOptionalParam<string>('tokenType', `specify the type of token to be sent ('hopr' or 'native'), if needed. Defaut value means sending both tokens`, undefined, types.string)
