...
export const SECRET_PRE_IMAGE = soliditySha3({ type: 'string', value: 'secret' })
export const SECRET = soliditySha3({ type: 'bytes32', value: SECRET_PRE_IMAGE })
