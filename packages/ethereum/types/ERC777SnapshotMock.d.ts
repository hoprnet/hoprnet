...
interface ERC777SnapshotMockInterface extends ethers.utils.Interface {
  functions: {
    ...
    'getAccountValueAt(address,uint128)': FunctionFragment
    'getTotalSupplyValueAt(uint128)': FunctionFragment
    ...
    'updateValueAtNowAccount(address,uint256)': FunctionFragment
  }
  ...
  encodeFunctionData(functionFragment: 'burn', values: [string, BigNumberish, BytesLike, BytesLike]): string
  encodeFunctionData(functionFragment: 'decimals', values?: undefined): string
  encodeFunctionData(functionFragment: 'defaultOperators', values?: undefined): string
  encodeFunctionData(functionFragment: 'getAccountValueAt', values: [string, BigNumberish]): string
  encodeFunctionData(functionFragment: 'getTotalSupplyValueAt', values: [BigNumberish]): string
  ...
  encodeFunctionData(functionFragment: 'updateValueAtNowAccount', values: [string, BigNumberish]): string
  ...
  decodeFunctionResult(functionFragment: 'getAccountValueAt', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getTotalSupplyValueAt', data: BytesLike): Result
  ...
  decodeFunctionResult(functionFragment: 'updateValueAtNowAccount', data: BytesLike): Result
...
export class ERC777SnapshotMock extends BaseContract {
