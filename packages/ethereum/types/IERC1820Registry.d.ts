...
export type ManagerChangedEvent = TypedEvent<[string, string] & { account: string; newManager: string }>
...
export class IERC1820Registry extends BaseContract {
  ...
  filters: {
    ...
    ): TypedEventFilter<[string, string, string], { account: string; interfaceHash: string; implementer: string }>
    ...
    ): TypedEventFilter<[string, string], { account: string; newManager: string }>
