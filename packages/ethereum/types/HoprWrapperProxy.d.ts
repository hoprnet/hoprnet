...
interface HoprWrapperProxyInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'WXHOPR_TOKEN', values?: undefined): string
  encodeFunctionData(functionFragment: 'XDAI_MULTISIG', values?: undefined): string
  encodeFunctionData(functionFragment: 'XHOPR_TOKEN', values?: undefined): string
  ...
  decodeFunctionResult(functionFragment: 'WXHOPR_TOKEN', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'XDAI_MULTISIG', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'XHOPR_TOKEN', data: BytesLike): Result
...
export type FowardedFromEvent = TypedEvent<[string, BigNumber] & { from: string; amount: BigNumber }>

export type FowardedToEvent = TypedEvent<[string, BigNumber] & { to: string; amount: BigNumber }>
...
export class HoprWrapperProxy extends BaseContract {
  ...
  filters: {
    ...
    FowardedFrom(from?: null, amount?: null): TypedEventFilter<[string, BigNumber], { from: string; amount: BigNumber }>
    ...
    FowardedTo(to?: null, amount?: null): TypedEventFilter<[string, BigNumber], { to: string; amount: BigNumber }>
  }
