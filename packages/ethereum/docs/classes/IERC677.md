[@hoprnet/hopr-ethereum](../README.md) / [Exports](../modules.md) / IERC677
...
- [constructor](IERC677.md#constructor)

### Properties

- [\_deployedPromise](IERC677.md#_deployedpromise)
- [\_runningEvents](IERC677.md#_runningevents)
- [\_wrappedEmits](IERC677.md#_wrappedemits)
- [address](IERC677.md#address)
- [callStatic](IERC677.md#callstatic)
- [deployTransaction](IERC677.md#deploytransaction)
- [estimateGas](IERC677.md#estimategas)
- [filters](IERC677.md#filters)
- [functions](IERC677.md#functions)
- [interface](IERC677.md#interface)
- [populateTransaction](IERC677.md#populatetransaction)
- [provider](IERC677.md#provider)
- [resolvedAddress](IERC677.md#resolvedaddress)
- [signer](IERC677.md#signer)

### Methods

- [\_checkRunningEvents](IERC677.md#_checkrunningevents)
- [\_deployed](IERC677.md#_deployed)
- [\_wrapEvent](IERC677.md#_wrapevent)
- [allowance](IERC677.md#allowance)
- [approve](IERC677.md#approve)
- [attach](IERC677.md#attach)
- [balanceOf](IERC677.md#balanceof)
- [connect](IERC677.md#connect)
- [decreaseAllowance](IERC677.md#decreaseallowance)
- [deployed](IERC677.md#deployed)
- [emit](IERC677.md#emit)
- [fallback](IERC677.md#fallback)
- [increaseAllowance](IERC677.md#increaseallowance)
- [listenerCount](IERC677.md#listenercount)
- [listeners](IERC677.md#listeners)
- [off](IERC677.md#off)
- [on](IERC677.md#on)
- [once](IERC677.md#once)
- [queryFilter](IERC677.md#queryfilter)
- [removeAllListeners](IERC677.md#removealllisteners)
- [removeListener](IERC677.md#removelistener)
- [totalSupply](IERC677.md#totalsupply)
- [transfer](IERC677.md#transfer)
- [transferAndCall](IERC677.md#transferandcall)
- [transferFrom](IERC677.md#transferfrom)
- [getContractAddress](IERC677.md#getcontractaddress)
- [getInterface](IERC677.md#getinterface)
- [isIndexed](IERC677.md#isindexed)

## Constructors

### constructor

• **new IERC677**(`addressOrName`, `contractInterface`, `signerOrProvider?`)
...
| `transferAndCall` | (`to`: `string`, `value`: `BigNumberish`, `data`: `BytesLike`, `overrides?`: `Overrides` & { `from?`: `string` \| `Promise`<`string`\>  }) => `Promise`<`BigNumber`\> |
...
| `transferAndCall` | (`to`: `string`, `value`: `BigNumberish`, `data`: `BytesLike`, `overrides?`: `Overrides` & { `from?`: `string` \| `Promise`<`string`\>  }) => `Promise`<`ContractTransaction`\> |
...
| `transferAndCall` | (`to`: `string`, `value`: `BigNumberish`, `data`: `BytesLike`, `overrides?`: `Overrides` & { `from?`: `string` \| `Promise`<`string`\>  }) => `Promise`<`PopulatedTransaction`\> |
...
▸ **attach**(`addressOrName`): [`IERC677`](IERC677.md)
...
▸ **connect**(`signerOrProvider`): [`IERC677`](IERC677.md)
...
▸ **deployed**(): `Promise`<[`IERC677`](IERC677.md)\>

#### Returns

`Promise`<[`IERC677`](IERC677.md)\>
...
▸ **off**<`EventArgsArray`, `EventArgsObject`\>(`eventFilter`, `listener`): [`IERC677`](IERC677.md)
...
▸ **on**<`EventArgsArray`, `EventArgsObject`\>(`eventFilter`, `listener`): [`IERC677`](IERC677.md)
...
▸ **once**<`EventArgsArray`, `EventArgsObject`\>(`eventFilter`, `listener`): [`IERC677`](IERC677.md)
...
▸ **removeAllListeners**<`EventArgsArray`, `EventArgsObject`\>(`eventFilter`): [`IERC677`](IERC677.md)
...
▸ **removeListener**<`EventArgsArray`, `EventArgsObject`\>(`eventFilter`, `listener`): [`IERC677`](IERC677.md)
...
▸ **transferAndCall**(`to`, `value`, `data`, `overrides?`): `Promise`<`ContractTransaction`\>
