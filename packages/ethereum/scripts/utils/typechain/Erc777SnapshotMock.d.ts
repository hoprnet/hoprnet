...
export interface Erc777SnapshotMockContract
  extends Truffle.Contract<Erc777SnapshotMockInstance> {
  "new"(
    name: string,
    symbol: string,
  ...
  ): Promise<Erc777SnapshotMockInstance>;
}
...
export interface Erc777SnapshotMockInstance extends Truffle.ContractInstance {
  allowance(
    holder: string,
    spender: string,
