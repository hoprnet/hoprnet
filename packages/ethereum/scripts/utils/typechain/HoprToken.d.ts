...
export interface HoprTokenContract extends Truffle.Contract<HoprTokenInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<HoprTokenInstance>;
}
...
export interface HoprTokenInstance extends Truffle.ContractInstance {
