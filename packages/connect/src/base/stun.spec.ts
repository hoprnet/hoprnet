...
//     assert(
//       isUsableResult([{ response: ip6address }] as Request[], true).length == 0,
//       `Must not accept IPv6 addresses in local-mode`
//     )
//     assert(
//       isUsableResult([{ response: ip6address }] as Request[], false).length == 0,
...
//     assert(
//       isUsableResult([{ response: localhostAddress }] as Request[], true).length == 1,
//       `Must accept localhost addresses in local-mode`
//     )
//     assert(
//       isUsableResult([{ response: localhostAddress }] as Request[], false).length == 0,
...
//     assert(
//       isUsableResult([{ response: localAddress }] as Request[], true).length == 1,
//       `Must accept local addresses in local-mode`
//     )
//     assert(
//       isUsableResult([{ response: localAddress }] as Request[], false).length == 0,
...
//     assert(
//       isUsableResult([{ response: publicAddress }] as Request[], true).length == 0,
//       `Must not accept public addresses in local-mode`
//     )
//     assert(
//       isUsableResult([{ response: publicAddress }] as Request[], false).length == 1,
//       `Must accept public addresses in normal-mode`
//     )

//     assert(isUsableResult([] as Request[]).length == 0, `Must not accept empty responses`)
//   })
