    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AccountGetAddresses200Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "native" => intermediate_rep.native.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "hopr" => intermediate_rep.hopr.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AccountGetAddresses200Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<AccountGetAddresses200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AccountGetAddresses200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AccountGetAddresses200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
             ...
             std::result::Result::Ok(value) => {
                    match <AccountGetAddresses200Response as std::str::FromStr>::from_str(value) {
                        ...
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AccountGetAddresses200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::string::ToString for AccountGetBalances200Response {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.safe_native.as_ref().map(|safe_native| {
                vec![
                    "safeNative".to_string(),
                    safe_native.to_string(),
                ].join(",")
            }),


            self.safe_hopr.as_ref().map(|safe_hopr| {
                vec![
                    "safeHopr".to_string(),
                    safe_hopr.to_string(),
                ].join(",")
            ...
            self.safe_hopr_allowance.as_ref().map(|safe_hopr_allowance| {
                vec![
                    "safeHoprAllowance".to_string(),
                    safe_hopr_allowance.to_string(),
                ].join(",")
            }),
...
impl std::str::FromStr for AccountGetBalances200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AccountGetBalances200Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "hopr" => intermediate_rep.hopr.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "safeNative" => intermediate_rep.safe_native.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "safeHopr" => intermediate_rep.safe_hopr.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "safeHoprAllowance" => intermediate_rep.safe_hopr_allowance.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AccountGetBalances200Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<AccountGetBalances200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AccountGetBalances200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AccountGetBalances200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AccountGetBalances200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AccountGetBalances200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::string::ToString for AccountWithdraw200Response {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.receipt.as_ref().map(|receipt| {
                vec![
                    "receipt".to_string(),
                    receipt.to_string(),
                ].join(",")
...
impl std::str::FromStr for AccountWithdraw200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AccountWithdraw200Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "receipt" => intermediate_rep.receipt.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AccountWithdraw200Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<AccountWithdraw200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AccountWithdraw200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AccountWithdraw200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AccountWithdraw200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AccountWithdraw200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for AccountWithdraw422Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AccountWithdraw422Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    _ => return std::result::Result::Err("Unexpected key while parsing AccountWithdraw422Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<AccountWithdraw422Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AccountWithdraw422Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AccountWithdraw422Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AccountWithdraw422Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AccountWithdraw422Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for AccountWithdrawRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AccountWithdrawRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "amount" => intermediate_rep.amount.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "ethereumAddress" => intermediate_rep.ethereum_address.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AccountWithdrawRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(AccountWithdrawRequest {
            currency: intermediate_rep.currency.into_iter().next().ok_or_else(|| "currency missing in AccountWithdrawRequest".to_string())?,
            amount: intermediate_rep.amount.into_iter().next().ok_or_else(|| "amount missing in AccountWithdrawRequest".to_string())?,
            ethereum_address: intermediate_rep.ethereum_address.into_iter().next().ok_or_else(|| "ethereumAddress missing in AccountWithdrawRequest".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<AccountWithdrawRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AccountWithdrawRequest>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AccountWithdrawRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<AccountWithdrawRequest> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AccountWithdrawRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AccountWithdrawRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for AliasesGetAlias200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AliasesGetAlias200Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "peerId" => intermediate_rep.peer_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AliasesGetAlias200Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<AliasesGetAlias200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AliasesGetAlias200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AliasesGetAlias200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AliasesGetAlias200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AliasesGetAlias200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for AliasesGetAliases200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AliasesGetAliases200Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "alice" => intermediate_rep.alice.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "bob" => intermediate_rep.bob.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing AliasesGetAliases200Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<AliasesGetAliases200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AliasesGetAliases200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AliasesGetAliases200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AliasesGetAliases200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AliasesGetAliases200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for AliasesSetAliasRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing AliasesSetAliasRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    _ => return std::result::Result::Err("Unexpected key while parsing AliasesSetAliasRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(AliasesSetAliasRequest {
            peer_id: intermediate_rep.peer_id.into_iter().next().ok_or_else(|| "peerId missing in AliasesSetAliasRequest".to_string())?,
            alias: intermediate_rep.alias.into_iter().next().ok_or_else(|| "alias missing in AliasesSetAliasRequest".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<AliasesSetAliasRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<AliasesSetAliasRequest>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for AliasesSetAliasRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<AliasesSetAliasRequest> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <AliasesSetAliasRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into AliasesSetAliasRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::string::ToString for Channel {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.balance.as_ref().map(|balance| {
                vec![
                    "balance".to_string(),
                    balance.to_string(),
                ].join(",")
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "peerId" => intermediate_rep.peer_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "status" => intermediate_rep.status.push(<models::ChannelStatus as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "balance" => intermediate_rep.balance.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
impl std::convert::TryFrom<header::IntoHeaderValue<Channel>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Channel>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Channel - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Channel as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into Channel - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::string::ToString for ChannelTopology {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.source_peer_id.as_ref().map(|source_peer_id| {
                vec![
                    "sourcePeerId".to_string(),
            ...
            self.destination_peer_id.as_ref().map(|destination_peer_id| {
                vec![
                    "destinationPeerId".to_string(),
                    destination_peer_id.to_string(),
                ].join(",")
            }),


            self.source_address.as_ref().map(|source_address| {
                vec![
            ...
            self.ticket_index.as_ref().map(|ticket_index| {
                vec![
                    "ticketIndex".to_string(),
                    ticket_index.to_string(),
                ].join(",")
            }),


            self.channel_epoch.as_ref().map(|channel_epoch| {
                vec![
                    "channelEpoch".to_string(),
                    channel_epoch.to_string(),
                ].join(",")
            }),


            self.closure_time.as_ref().map(|closure_time| {
                vec![
                    "closureTime".to_string(),
                    closure_time.to_string(),
                ].join(",")
            }),
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "channelId" => intermediate_rep.channel_id.push(<serde_json::Value as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "sourcePeerId" => intermediate_rep.source_peer_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "destinationPeerId" => intermediate_rep.destination_peer_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "sourceAddress" => intermediate_rep.source_address.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "destinationAddress" => intermediate_rep.destination_address.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "balance" => intermediate_rep.balance.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "status" => intermediate_rep.status.push(<models::ChannelStatus as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "ticketIndex" => intermediate_rep.ticket_index.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "channelEpoch" => intermediate_rep.channel_epoch.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "closureTime" => intermediate_rep.closure_time.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
impl std::convert::TryFrom<header::IntoHeaderValue<ChannelTopology>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ChannelTopology>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ChannelTopology - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<ChannelTopology> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ChannelTopology as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ChannelTopology - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::string::ToString for ChannelsCloseChannel200Response {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.channel_status.as_ref().map(|channel_status| {
                vec![
                    "channelStatus".to_string(),
                    channel_status.to_string(),
                ].join(",")
            }),
...
impl std::str::FromStr for ChannelsCloseChannel200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ChannelsCloseChannel200Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "receipt" => intermediate_rep.receipt.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "channelStatus" => intermediate_rep.channel_status.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ChannelsCloseChannel200Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<ChannelsCloseChannel200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ChannelsCloseChannel200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ChannelsCloseChannel200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ChannelsCloseChannel200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ChannelsCloseChannel200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl ChannelsFundChannel200Response {
    ...
    pub fn new(receipt: String, ) -> ChannelsFundChannel200Response {
        ChannelsFundChannel200Response {
            receipt,
        }
    }
}
...
impl std::str::FromStr for ChannelsFundChannel200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ChannelsFundChannel200Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "receipt" => intermediate_rep.receipt.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ChannelsFundChannel200Response".to_string())
                }
            }
        ...
        std::result::Result::Ok(ChannelsFundChannel200Response {
            receipt: intermediate_rep.receipt.into_iter().next().ok_or_else(|| "receipt missing in ChannelsFundChannel200Response".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ChannelsFundChannel200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ChannelsFundChannel200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ChannelsFundChannel200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ChannelsFundChannel200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ChannelsFundChannel200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for ChannelsFundChannelRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ChannelsFundChannelRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "amount" => intermediate_rep.amount.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ChannelsFundChannelRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(ChannelsFundChannelRequest {
            amount: intermediate_rep.amount.into_iter().next().ok_or_else(|| "amount missing in ChannelsFundChannelRequest".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ChannelsFundChannelRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ChannelsFundChannelRequest>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ChannelsFundChannelRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ChannelsFundChannelRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ChannelsFundChannelRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for ChannelsGetChannels200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ChannelsGetChannels200Response".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    "incoming" => return std::result::Result::Err("Parsing a container in this style is not supported in ChannelsGetChannels200Response".to_string()),
                    "outgoing" => return std::result::Result::Err("Parsing a container in this style is not supported in ChannelsGetChannels200Response".to_string()),
                    "all" => return std::result::Result::Err("Parsing a container in this style is not supported in ChannelsGetChannels200Response".to_string()),
                    _ => return std::result::Result::Err("Unexpected key while parsing ChannelsGetChannels200Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<ChannelsGetChannels200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ChannelsGetChannels200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ChannelsGetChannels200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ChannelsGetChannels200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ChannelsGetChannels200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for ChannelsOpenChannel201Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ChannelsOpenChannel201Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "channelId" => intermediate_rep.channel_id.push(<serde_json::Value as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "transactionReceipt" => intermediate_rep.transaction_receipt.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ChannelsOpenChannel201Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<ChannelsOpenChannel201Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ChannelsOpenChannel201Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ChannelsOpenChannel201Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ChannelsOpenChannel201Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ChannelsOpenChannel201Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl ChannelsOpenChannel403Response {
    ...
    pub fn new() -> ChannelsOpenChannel403Response {
        ChannelsOpenChannel403Response {
            status: None,
        }
    }
}
...
impl std::str::FromStr for ChannelsOpenChannel403Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ChannelsOpenChannel403Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "status" => intermediate_rep.status.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ChannelsOpenChannel403Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<ChannelsOpenChannel403Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ChannelsOpenChannel403Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ChannelsOpenChannel403Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ChannelsOpenChannel403Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ChannelsOpenChannel403Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl ChannelsOpenChannel409Response {
    ...
    pub fn new() -> ChannelsOpenChannel409Response {
        ChannelsOpenChannel409Response {
            status: None,
        }
    }
}
...
impl std::str::FromStr for ChannelsOpenChannel409Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ChannelsOpenChannel409Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "status" => intermediate_rep.status.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ChannelsOpenChannel409Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<ChannelsOpenChannel409Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ChannelsOpenChannel409Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ChannelsOpenChannel409Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ChannelsOpenChannel409Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ChannelsOpenChannel409Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for ChannelsOpenChannelRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing ChannelsOpenChannelRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "peerAddress" => intermediate_rep.peer_address.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "amount" => intermediate_rep.amount.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing ChannelsOpenChannelRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(ChannelsOpenChannelRequest {
            peer_address: intermediate_rep.peer_address.into_iter().next().ok_or_else(|| "peerAddress missing in ChannelsOpenChannelRequest".to_string())?,
            amount: intermediate_rep.amount.into_iter().next().ok_or_else(|| "amount missing in ChannelsOpenChannelRequest".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ChannelsOpenChannelRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ChannelsOpenChannelRequest>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ChannelsOpenChannelRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ChannelsOpenChannelRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ChannelsOpenChannelRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for Error {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        std::result::Result::Ok(Error {
            status: intermediate_rep.status.into_iter().next().ok_or_else(|| "status missing in Error".to_string())?,
...
impl std::str::FromStr for MessagesGetSize200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing MessagesGetSize200Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    _ => return std::result::Result::Err("Unexpected key while parsing MessagesGetSize200Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<MessagesGetSize200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<MessagesGetSize200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for MessagesGetSize200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <MessagesGetSize200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into MessagesGetSize200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl MessagesPopAllMessage200Response {
    ...
    pub fn new(messages: Vec<models::ReceivedMessage>, ) -> MessagesPopAllMessage200Response {
        MessagesPopAllMessage200Response {
            messages,
        }
    }
}
...
impl std::str::FromStr for MessagesPopAllMessage200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing MessagesPopAllMessage200Response".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    "messages" => return std::result::Result::Err("Parsing a container in this style is not supported in MessagesPopAllMessage200Response".to_string()),
                    _ => return std::result::Result::Err("Unexpected key while parsing MessagesPopAllMessage200Response".to_string())
                }
            }
        ...
        std::result::Result::Ok(MessagesPopAllMessage200Response {
            messages: intermediate_rep.messages.into_iter().next().ok_or_else(|| "messages missing in MessagesPopAllMessage200Response".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<MessagesPopAllMessage200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<MessagesPopAllMessage200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for MessagesPopAllMessage200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <MessagesPopAllMessage200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into MessagesPopAllMessage200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for MessagesPopAllMessageRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing MessagesPopAllMessageRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "tag" => intermediate_rep.tag.push(<u32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing MessagesPopAllMessageRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(MessagesPopAllMessageRequest {
            tag: intermediate_rep.tag.into_iter().next().ok_or_else(|| "tag missing in MessagesPopAllMessageRequest".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<MessagesPopAllMessageRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<MessagesPopAllMessageRequest>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for MessagesPopAllMessageRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <MessagesPopAllMessageRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into MessagesPopAllMessageRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for MessagesSendMessageRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing MessagesSendMessageRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "peerId" => intermediate_rep.peer_id.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "path" => return std::result::Result::Err("Parsing a container in this style is not supported in MessagesSendMessageRequest".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "hops" => intermediate_rep.hops.push(<u8 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing MessagesSendMessageRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(MessagesSendMessageRequest {
            tag: intermediate_rep.tag.into_iter().next().ok_or_else(|| "tag missing in MessagesSendMessageRequest".to_string())?,
            body: intermediate_rep.body.into_iter().next().ok_or_else(|| "body missing in MessagesSendMessageRequest".to_string())?,
            peer_id: intermediate_rep.peer_id.into_iter().next().ok_or_else(|| "peerId missing in MessagesSendMessageRequest".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<MessagesSendMessageRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<MessagesSendMessageRequest>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for MessagesSendMessageRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <MessagesSendMessageRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into MessagesSendMessageRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::string::ToString for NodeGetEntryNodes200ResponseValue {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.is_eligible.as_ref().map(|is_eligible| {
                vec![
                    "isEligible".to_string(),
...
impl std::str::FromStr for NodeGetEntryNodes200ResponseValue {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing NodeGetEntryNodes200ResponseValue".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    "multiaddrs" => return std::result::Result::Err("Parsing a container in this style is not supported in NodeGetEntryNodes200ResponseValue".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "isEligible" => intermediate_rep.is_eligible.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing NodeGetEntryNodes200ResponseValue".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<NodeGetEntryNodes200ResponseValue>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<NodeGetEntryNodes200ResponseValue>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for NodeGetEntryNodes200ResponseValue - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <NodeGetEntryNodes200ResponseValue as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into NodeGetEntryNodes200ResponseValue - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
        ...
        let params: Vec<Option<String>> = vec![
            ...
            self.announced_address.as_ref().map(|announced_address| {
                vec![
                    ...
                    announced_address.iter().map(|x| x.to_string()).collect::<Vec<_>>().join(","),
                ].join(",")
            }),
            ...
            self.listening_address.as_ref().map(|listening_address| {
                vec![
                    ...
                    listening_address.iter().map(|x| x.to_string()).collect::<Vec<_>>().join(","),
                ].join(",")
            }),
            ...
            self.hopr_token.as_ref().map(|hopr_token| {
                vec![
                    "hoprToken".to_string(),
                    hopr_token.to_string(),
                ].join(",")
            }),


            self.hopr_channels.as_ref().map(|hopr_channels| {
                vec![
                    "hoprChannels".to_string(),
                    hopr_channels.to_string(),
                ].join(",")
            }),


            self.hopr_network_registry_address.as_ref().map(|hopr_network_registry_address| {
                vec![
            ...
            self.hopr_node_safe_registry_address.as_ref().map(|hopr_node_safe_registry_address| {
                vec![
            ...
            self.node_management_module.as_ref().map(|node_management_module| {
                vec![
                    "nodeManagementModule".to_string(),
                    node_management_module.to_string(),
                ].join(",")
            }),


            self.node_safe.as_ref().map(|node_safe| {
                vec![
                    "nodeSafe".to_string(),
                    node_safe.to_string(),
                ].join(",")
            ...
            self.connectivity_status.as_ref().map(|connectivity_status| {
                vec![
                    "connectivityStatus".to_string(),
                    connectivity_status.to_string(),
                ].join(",")
            }),
            ...
            self.channel_closure_period.as_ref().map(|channel_closure_period| {
                vec![
                    "channelClosurePeriod".to_string(),
                    channel_closure_period.to_string(),
                ].join(",")
            }),
...
impl std::str::FromStr for NodeGetInfo200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing NodeGetInfo200Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "announcedAddress" => return std::result::Result::Err("Parsing a container in this style is not supported in NodeGetInfo200Response".to_string()),
                    "listeningAddress" => return std::result::Result::Err("Parsing a container in this style is not supported in NodeGetInfo200Response".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "chain" => intermediate_rep.chain.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "hoprToken" => intermediate_rep.hopr_token.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "hoprChannels" => intermediate_rep.hopr_channels.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "hoprNetworkRegistryAddress" => intermediate_rep.hopr_network_registry_address.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "hoprNodeSafeRegistryAddress" => intermediate_rep.hopr_node_safe_registry_address.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "nodeManagementModule" => intermediate_rep.node_management_module.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "nodeSafe" => intermediate_rep.node_safe.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "connectivityStatus" => intermediate_rep.connectivity_status.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "isEligible" => intermediate_rep.is_eligible.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "channelClosurePeriod" => intermediate_rep.channel_closure_period.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing NodeGetInfo200Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<NodeGetInfo200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<NodeGetInfo200Response>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for NodeGetInfo200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<NodeGetInfo200Response> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <NodeGetInfo200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into NodeGetInfo200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for NodeGetPeers200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing NodeGetPeers200Response".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    "connected" => return std::result::Result::Err("Parsing a container in this style is not supported in NodeGetPeers200Response".to_string()),
                    "announced" => return std::result::Result::Err("Parsing a container in this style is not supported in NodeGetPeers200Response".to_string()),
                    _ => return std::result::Result::Err("Unexpected key while parsing NodeGetPeers200Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<NodeGetPeers200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<NodeGetPeers200Response>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for NodeGetPeers200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<NodeGetPeers200Response> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <NodeGetPeers200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into NodeGetPeers200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::string::ToString for NodeGetPeers200ResponseConnectedInner {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.peer_address.as_ref().map(|peer_address| {
                vec![
            ...
            self.multi_addr.as_ref().map(|multi_addr| {
                vec![
                    "multiAddr".to_string(),
            ...
            self.last_seen_latency.as_ref().map(|last_seen_latency| {
                vec![
                    "lastSeenLatency".to_string(),
                    last_seen_latency.to_string(),
                ].join(",")
            }),
            ...
            self.backoff.as_ref().map(|backoff| {
                vec![
                    "backoff".to_string(),
                    backoff.to_string(),
                ].join(",")
            ...
            self.reported_version.as_ref().map(|reported_version| {
                vec![
                    "reportedVersion".to_string(),
...
impl std::str::FromStr for NodeGetPeers200ResponseConnectedInner {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing NodeGetPeers200ResponseConnectedInner".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "peerAddress" => intermediate_rep.peer_address.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "multiAddr" => intermediate_rep.multi_addr.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "heartbeats" => intermediate_rep.heartbeats.push(<models::NodeGetPeers200ResponseConnectedInnerHeartbeats as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "lastSeen" => intermediate_rep.last_seen.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "lastSeenLatency" => intermediate_rep.last_seen_latency.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "quality" => intermediate_rep.quality.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "backoff" => intermediate_rep.backoff.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "isNew" => intermediate_rep.is_new.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "reportedVersion" => intermediate_rep.reported_version.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing NodeGetPeers200ResponseConnectedInner".to_string())
                }
            }
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<NodeGetPeers200ResponseConnectedInner>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<NodeGetPeers200ResponseConnectedInner>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for NodeGetPeers200ResponseConnectedInner - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<NodeGetPeers200ResponseConnectedInner> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <NodeGetPeers200ResponseConnectedInner as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into NodeGetPeers200ResponseConnectedInner - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for NodeGetPeers200ResponseConnectedInnerHeartbeats {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing NodeGetPeers200ResponseConnectedInnerHeartbeats".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "sent" => intermediate_rep.sent.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "success" => intermediate_rep.success.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing NodeGetPeers200ResponseConnectedInnerHeartbeats".to_string())
                }
            }
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<NodeGetPeers200ResponseConnectedInnerHeartbeats>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<NodeGetPeers200ResponseConnectedInnerHeartbeats>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for NodeGetPeers200ResponseConnectedInnerHeartbeats - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<NodeGetPeers200ResponseConnectedInnerHeartbeats> {
    type Error = String;
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <NodeGetPeers200ResponseConnectedInnerHeartbeats as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into NodeGetPeers200ResponseConnectedInnerHeartbeats - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for PeerInfoGetPeerInfo200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing PeerInfoGetPeerInfo200Response".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    "announced" => return std::result::Result::Err("Parsing a container in this style is not supported in PeerInfoGetPeerInfo200Response".to_string()),
                    "observed" => return std::result::Result::Err("Parsing a container in this style is not supported in PeerInfoGetPeerInfo200Response".to_string()),
                    _ => return std::result::Result::Err("Unexpected key while parsing PeerInfoGetPeerInfo200Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<PeerInfoGetPeerInfo200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PeerInfoGetPeerInfo200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PeerInfoGetPeerInfo200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PeerInfoGetPeerInfo200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into PeerInfoGetPeerInfo200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for PeersPingPeer200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing PeersPingPeer200Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "latency" => intermediate_rep.latency.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "reportedVersion" => intermediate_rep.reported_version.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing PeersPingPeer200Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<PeersPingPeer200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<PeersPingPeer200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for PeersPingPeer200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<PeersPingPeer200Response> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <PeersPingPeer200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into PeersPingPeer200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for ReceivedMessage {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "body" => intermediate_rep.body.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "receivedAt" => intermediate_rep.received_at.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
        ...
        std::result::Result::Ok(ReceivedMessage {
            tag: intermediate_rep.tag.into_iter().next().ok_or_else(|| "tag missing in ReceivedMessage".to_string())?,
            body: intermediate_rep.body.into_iter().next().ok_or_else(|| "body missing in ReceivedMessage".to_string())?,
            received_at: intermediate_rep.received_at.into_iter().next().ok_or_else(|| "receivedAt missing in ReceivedMessage".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<ReceivedMessage>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<ReceivedMessage>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for ReceivedMessage - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<ReceivedMessage> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <ReceivedMessage as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into ReceivedMessage - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::convert::TryFrom<header::IntoHeaderValue<RequestStatus>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<RequestStatus>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for RequestStatus - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<RequestStatus> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <RequestStatus as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into RequestStatus - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::string::ToString for Settings {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.include_recipient.as_ref().map(|include_recipient| {
                vec![
                    "includeRecipient".to_string(),
                    include_recipient.to_string(),
                ].join(",")
            }),


            self.strategy.as_ref().map(|strategy| {
                vec![
                    "strategy".to_string(),
                    strategy.to_string(),
                ].join(",")
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "includeRecipient" => intermediate_rep.include_recipient.push(<bool as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "strategy" => intermediate_rep.strategy.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
impl std::convert::TryFrom<header::IntoHeaderValue<Settings>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Settings>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Settings - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Settings> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Settings as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into Settings - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for SettingsSetSettingRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing SettingsSetSettingRequest".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "settingValue" => intermediate_rep.setting_value.push(<serde_json::Value as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing SettingsSetSettingRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(SettingsSetSettingRequest {
            setting_value: intermediate_rep.setting_value.into_iter().next().ok_or_else(|| "settingValue missing in SettingsSetSettingRequest".to_string())?,
        })
    }
}
...
impl std::convert::TryFrom<header::IntoHeaderValue<SettingsSetSettingRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<SettingsSetSettingRequest>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for SettingsSetSettingRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<SettingsSetSettingRequest> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <SettingsSetSettingRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into SettingsSetSettingRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::string::ToString for Ticket {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.index_offset.as_ref().map(|index_offset| {
                vec![
            ...
            self.win_prob.as_ref().map(|win_prob| {
                vec![
                    "winProb".to_string(),
                    win_prob.to_string(),
                ].join(",")
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "indexOffset" => intermediate_rep.index_offset.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "channelEpoch" => intermediate_rep.channel_epoch.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "winProb" => intermediate_rep.win_prob.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
...
impl std::convert::TryFrom<header::IntoHeaderValue<Ticket>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<Ticket>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for Ticket - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<Ticket> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <Ticket as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into Ticket - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::string::ToString for TicketsGetStatistics200Response {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.unredeemed.as_ref().map(|unredeemed| {
                vec![
                    "unredeemed".to_string(),
                    unredeemed.to_string(),
                ].join(",")
            }),


            self.unredeemed_value.as_ref().map(|unredeemed_value| {
                vec![
                    "unredeemedValue".to_string(),
                    unredeemed_value.to_string(),
                ].join(",")
            }),


            self.redeemed.as_ref().map(|redeemed| {
                vec![
                    "redeemed".to_string(),
                    redeemed.to_string(),
                ].join(",")
            ...
            self.redeemed_value.as_ref().map(|redeemed_value| {
                vec![
                    "redeemedValue".to_string(),
                    redeemed_value.to_string(),
                ].join(",")
            }),


            self.losing_tickets.as_ref().map(|losing_tickets| {
                vec![
                    "losingTickets".to_string(),
                    losing_tickets.to_string(),
                ].join(",")
            }),


            self.win_proportion.as_ref().map(|win_proportion| {
                vec![
                    "winProportion".to_string(),
                    win_proportion.to_string(),
                ].join(",")
            }),


            self.neglected.as_ref().map(|neglected| {
                vec![
                    "neglected".to_string(),
                    neglected.to_string(),
                ].join(",")
            ...
            self.neglected_value.as_ref().map(|neglected_value| {
                vec![
                    "neglectedValue".to_string(),
                    neglected_value.to_string(),
                ].join(",")
            }),


            self.rejected.as_ref().map(|rejected| {
                vec![
                    "rejected".to_string(),
                    rejected.to_string(),
                ].join(",")
            ...
            self.rejected_value.as_ref().map(|rejected_value| {
                vec![
                    "rejectedValue".to_string(),
...
impl std::str::FromStr for TicketsGetStatistics200Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing TicketsGetStatistics200Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "unredeemed" => intermediate_rep.unredeemed.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "unredeemedValue" => intermediate_rep.unredeemed_value.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "redeemed" => intermediate_rep.redeemed.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "redeemedValue" => intermediate_rep.redeemed_value.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "losingTickets" => intermediate_rep.losing_tickets.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "winProportion" => intermediate_rep.win_proportion.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "neglected" => intermediate_rep.neglected.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "neglectedValue" => intermediate_rep.neglected_value.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "rejected" => intermediate_rep.rejected.push(<f64 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "rejectedValue" => intermediate_rep.rejected_value.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing TicketsGetStatistics200Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<TicketsGetStatistics200Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<TicketsGetStatistics200Response>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for TicketsGetStatistics200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <TicketsGetStatistics200Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into TicketsGetStatistics200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::string::ToString for Token {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.valid_until.as_ref().map(|valid_until| {
                vec![
...
impl std::str::FromStr for Token {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "valid_until" => intermediate_rep.valid_until.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    "capabilities" => return std::result::Result::Err("Parsing a container in this style is not supported in Token".to_string()),
        ...
        std::result::Result::Ok(Token {
            id: intermediate_rep.id.into_iter().next().ok_or_else(|| "id missing in Token".to_string())?,
            description: intermediate_rep.description.into_iter().next(),
            valid_until: intermediate_rep.valid_until.into_iter().next(),
            capabilities: intermediate_rep.capabilities.into_iter().next().ok_or_else(|| "capabilities missing in Token".to_string())?,
        })
    }
}
...
impl std::str::FromStr for TokenCapability {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "limits" => return std::result::Result::Err("Parsing a container in this style is not supported in TokenCapability".to_string()),
        ...
        std::result::Result::Ok(TokenCapability {
            endpoint: intermediate_rep.endpoint.into_iter().next().ok_or_else(|| "endpoint missing in TokenCapability".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<TokenCapability>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<TokenCapability>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for TokenCapability - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<TokenCapability> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <TokenCapability as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into TokenCapability - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for TokenCapabilityLimit {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing TokenCapabilityLimit".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "type" => intermediate_rep.r#type.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "conditions" => intermediate_rep.conditions.push(<models::TokenCapabilityLimitConditions as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing TokenCapabilityLimit".to_string())
                }
            }
        ...
        std::result::Result::Ok(TokenCapabilityLimit {
            r#type: intermediate_rep.r#type.into_iter().next().ok_or_else(|| "type missing in TokenCapabilityLimit".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<TokenCapabilityLimit>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<TokenCapabilityLimit>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for TokenCapabilityLimit - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<TokenCapabilityLimit> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <TokenCapabilityLimit as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into TokenCapabilityLimit - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl TokenCapabilityLimitConditions {
    ...
    pub fn new() -> TokenCapabilityLimitConditions {
        TokenCapabilityLimitConditions {
            max: None,
        }
    }
}
...
impl std::str::FromStr for TokenCapabilityLimitConditions {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing TokenCapabilityLimitConditions".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "max" => intermediate_rep.max.push(<i32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing TokenCapabilityLimitConditions".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<TokenCapabilityLimitConditions>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<TokenCapabilityLimitConditions>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for TokenCapabilityLimitConditions - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
        ...
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <TokenCapabilityLimitConditions as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into TokenCapabilityLimitConditions - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for TokensCreate201Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing TokensCreate201Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    _ => return std::result::Result::Err("Unexpected key while parsing TokensCreate201Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<TokensCreate201Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<TokensCreate201Response>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for TokensCreate201Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<TokensCreate201Response> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <TokensCreate201Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into TokensCreate201Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::str::FromStr for TokensCreate422Response {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing TokensCreate422Response".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "error" => intermediate_rep.error.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing TokensCreate422Response".to_string())
                }
            }
...
impl std::convert::TryFrom<header::IntoHeaderValue<TokensCreate422Response>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<TokensCreate422Response>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for TokensCreate422Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<TokensCreate422Response> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <TokensCreate422Response as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into TokensCreate422Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
impl std::string::ToString for TokensCreateRequest {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            ...
            self.lifetime.as_ref().map(|lifetime| {
                vec![
                    "lifetime".to_string(),
                    lifetime.to_string(),
                ].join(",")
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    "capabilities" => return std::result::Result::Err("Parsing a container in this style is not supported in TokensCreateRequest".to_string()),
                    #[allow(clippy::redundant_clone)]
                    "lifetime" => intermediate_rep.lifetime.push(<u32 as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "description" => intermediate_rep.description.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing TokensCreateRequest".to_string())
                }
            }
        ...
        std::result::Result::Ok(TokensCreateRequest {
            capabilities: intermediate_rep.capabilities.into_iter().next().ok_or_else(|| "capabilities missing in TokensCreateRequest".to_string())?,
...
impl std::convert::TryFrom<header::IntoHeaderValue<TokensCreateRequest>> for hyper::header::HeaderValue {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<TokensCreateRequest>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for TokensCreateRequest - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<TokensCreateRequest> {
    ...
    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <TokensCreateRequest as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into TokensCreateRequest - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
