...
pub enum AccountGetAddressResponse {
    ...
    AddressesFetchedSuccessfully
    (models::AccountGetAddresses200Response)
    ,
    ...
    /// Unknown failure.
    UnknownFailure
    (models::TokensCreate422Response)
}
...
pub enum AccountWithdrawResponse {
    ...
    WithdrawAmountExeedsCurrentBalanceOrUnknownError
    (models::AccountWithdraw422Response)
}
...
pub enum AliasesGetAliasResponse {
    ...
    HOPRAddressWasFoundForTheProvidedAlias
    (models::AliasesGetAlias200Response)
    ,
    /// authentication failed
    AuthenticationFailed
    (models::Error)
    ...
    ThisAliasWasNotAssignedToAnyPeerIdBefore
    (models::RequestStatus)
    ,
    /// Unknown failure.
    UnknownFailure
...
pub enum AliasesGetAliasesResponse {
    ...
    ReturnsListOfAliasesAndCorrespondingPeerIds
    (models::AliasesGetAliases200Response)
    ,
    /// Unknown failure.
    UnknownFailure
    (models::TokensCreate422Response)
...
pub enum ChannelsCloseChannelResponse {
    ...
    ChannelClosedSuccesfully
    (models::ChannelsCloseChannel200Response)
    ,
    /// Invalid channel id.
    InvalidChannelId
    (models::RequestStatus)
...
pub enum ChannelsFundChannelResponse {
    ...
    ChannelFundedSuccessfully
    (models::ChannelsFundChannel200Response)
    ,
    /// Invalid channel id.
    InvalidChannelId
    (models::RequestStatus)
...
pub enum ChannelsGetChannelResponse {
    ...
    ChannelFetchedSuccesfully
    (models::ChannelTopology)
    ,
    /// Invalid channel id.
    InvalidChannelId
    (models::RequestStatus)
...
pub enum ChannelsGetChannelsResponse {
    ...
    ChannelsFetchedSuccessfully
    (models::ChannelsGetChannels200Response)
    ,
    /// authentication failed
    AuthenticationFailed
    (models::Error)
...
pub enum ChannelsGetTicketsResponse {
    ...
    TicketsWereNotFoundForThatChannel
    (models::RequestStatus)
    ,
    /// Unknown failure.
    UnknownFailure
...
pub enum ChannelsOpenChannelResponse {
    ...
    ChannelSuccesfullyOpened
    (models::ChannelsOpenChannel201Response)
    ,
    /// Problem with inputs.
    ProblemWithInputs
    (models::RequestStatus)
    ...
    FailedToOpenTheChannelBecauseOfInsufficientHOPRBalanceOrAllowance
    (models::ChannelsOpenChannel403Response)
    ,
    /// Failed to open the channel because the channel between this nodes already exists.
    FailedToOpenTheChannelBecauseTheChannelBetweenThisNodesAlreadyExists
    (models::ChannelsOpenChannel409Response)
    ,
    /// Unknown failure.
    UnknownFailure
    (models::TokensCreate422Response)
...
pub enum MessagesGetSizeResponse {
    ...
    ReturnsTheMessageInboxSizeFilteredByTheGivenTag
    (models::MessagesGetSize200Response)
    ,
    /// authentication failed
    AuthenticationFailed
    (models::Error)
...
pub enum MessagesPopAllMessageResponse {
    ...
    (models::MessagesPopAllMessage200Response)
    ,
    /// authentication failed
    AuthenticationFailed
    (models::Error)
...
pub enum NodeGetInfoResponse {
    ...
    NodeInformationFetchedSuccessfuly
    (models::NodeGetInfo200Response)
    ,
    /// authentication failed
    AuthenticationFailed
    (models::Error)
...
pub enum NodeGetMetricsResponse {
    ...
    ReturnsTheEncodedSerializedMetrics
    (String)
    ,
    /// authentication failed
    AuthenticationFailed
...
pub enum NodeGetPeersResponse {
    ...
    PeersInformationFetchedSuccessfuly
    (models::NodeGetPeers200Response)
    ,
...
pub enum NodeGetVersionResponse {
    ...
    ReturnsTheReleaseVersionOfTheRunningNode
    (String)
    ,
    /// authentication failed
    AuthenticationFailed
...
pub enum PeerInfoGetPeerInfoResponse {
    ...
    PeerInformationFetchedSuccessfully
    (models::PeerInfoGetPeerInfo200Response)
    ,
    /// authentication failed
    AuthenticationFailed
    (models::Error)
...
pub enum PeersPingPeerResponse {
    /// Ping successful.
    PingSuccessful
    (models::PeersPingPeer200Response)
    ,
    /// Invalid peerId.
    InvalidPeerId
    (models::RequestStatus)
...
pub enum TicketsGetStatisticsResponse {
    ...
    TicketsStatisticsFetchedSuccessfully
    (models::TicketsGetStatistics200Response)
    ,
    /// authentication failed
    AuthenticationFailed
    (models::Error)
...
pub enum TokensCreateResponse {
    ...
    TokenSuccesfullyCreated
    (models::TokensCreate201Response)
    ,
    /// Problem with inputs.
    ProblemWithInputs
    (models::RequestStatus)
...
pub trait ApiNoContext<C: Send + Sync> {
    ...
    async fn account_get_address(
        &self,
        ) -> Result<AccountGetAddressResponse, ApiError>;

    async fn account_get_addresses(
        &self,
        ) -> Result<AccountGetAddressesResponse, ApiError>;

    async fn account_get_balances(
        &self,
        ) -> Result<AccountGetBalancesResponse, ApiError>;
    ...
    async fn aliases_get_alias(
        &self,
        alias: String,
        ) -> Result<AliasesGetAliasResponse, ApiError>;

    async fn aliases_get_aliases(
        &self,
        ) -> Result<AliasesGetAliasesResponse, ApiError>;
    ...
    async fn check_node_healthy(
        &self,
        ) -> Result<CheckNodeHealthyResponse, ApiError>;

    async fn check_node_ready(
        &self,
        ) -> Result<CheckNodeReadyResponse, ApiError>;

    async fn check_node_started(
        &self,
        ) -> Result<CheckNodeStartedResponse, ApiError>;
    ...
    async fn messages_get_size(
        &self,
        tag: i32,
        ) -> Result<MessagesGetSizeResponse, ApiError>;
    ...
    async fn messages_websocket(
        &self,
        ) -> Result<MessagesWebsocketResponse, ApiError>;

    async fn node_get_entry_nodes(
        &self,
        ) -> Result<NodeGetEntryNodesResponse, ApiError>;

    async fn node_get_info(
        &self,
        ) -> Result<NodeGetInfoResponse, ApiError>;

    async fn node_get_metrics(
        &self,
        ) -> Result<NodeGetMetricsResponse, ApiError>;

    async fn node_get_peers(
        &self,
        quality: Option<f64>,
        ) -> Result<NodeGetPeersResponse, ApiError>;

    async fn node_get_version(
        &self,
        ) -> Result<NodeGetVersionResponse, ApiError>;
    ...
    async fn peers_ping_peer(
        &self,
        peerid: String,
        ) -> Result<PeersPingPeerResponse, ApiError>;

    async fn settings_get_settings(
        &self,
        ) -> Result<SettingsGetSettingsResponse, ApiError>;
    ...
    async fn tickets_get_statistics(
        &self,
        ) -> Result<TicketsGetStatisticsResponse, ApiError>;

    async fn tickets_get_tickets(
        &self,
        ) -> Result<TicketsGetTicketsResponse, ApiError>;

    async fn tickets_redeem_tickets(
        &self,
        ) -> Result<TicketsRedeemTicketsResponse, ApiError>;
    ...
    async fn tokens_delete(
        &self,
        id: String,
        ) -> Result<TokensDeleteResponse, ApiError>;

    async fn tokens_get_token(
        &self,
        ) -> Result<TokensGetTokenResponse, ApiError>;
...
impl<T: Api<C> + Send + Sync, C: Clone + Send + Sync> ApiNoContext<C> for ContextWrapper<T, C> {
    ...
    {
        let context = self.context().clone();
        self.api().channels_fund_channel(channelid, channels_fund_channel_request, &context).await
    }
    ...
    {
        let context = self.context().clone();
        self.api().channels_get_channels(including_closed, full_topology, &context).await
    }
    ...
    {
        let context = self.context().clone();
        self.api().channels_open_channel(channels_open_channel_request, &context).await
    }
    ...
    {
        let context = self.context().clone();
        self.api().messages_pop_all_message(messages_pop_all_message_request, &context).await
    }
    ...
    {
        let context = self.context().clone();
        self.api().messages_pop_message(messages_pop_all_message_request, &context).await
    }
    ...
    {
        let context = self.context().clone();
        self.api().messages_send_message(messages_send_message_request, &context).await
    }
    ...
    {
        let context = self.context().clone();
        self.api().settings_set_setting(setting, settings_set_setting_request, &context).await
    }
