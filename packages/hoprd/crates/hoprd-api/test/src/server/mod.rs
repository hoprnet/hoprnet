...
mod paths {
    ...
    lazy_static! {
        pub static ref REGEX_ALIASES_ALIAS: regex::Regex =
    ...
    lazy_static! {
        pub static ref REGEX_PEERS_PEERID_: regex::Regex =
            #[allow(clippy::invalid_regex)]
    ...
    lazy_static! {
        pub static ref REGEX_TOKENS_ID: regex::Regex =
            #[allow(clippy::invalid_regex)]
        ...
        C: Has<XSpanIdString> + Has<Option<Authorization>> + Send + Sync + 'static
    {
        ...
        match method {
            ...
            hyper::Method::GET if path.matched(paths::ID_ACCOUNT_ADDRESS) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.account_get_address(
                                        &context
                                    ).await;
                                ...
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                AccountGetAddressResponse::AddressesFetchedSuccessfully
                                                    (body)
                                                => {
                                                ...
                                                AccountGetAddressResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                ...
                                                AccountGetAddressResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                ...
                                                AccountGetAddressResponse::UnknownFailure
                                                    (body)
                                                => {
            ...
            hyper::Method::GET if path.matched(paths::ID_ACCOUNT_ADDRESSES) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.account_get_addresses(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                AccountGetAddressesResponse::AddressesFetchedSuccessfully
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                AccountGetAddressesResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                AccountGetAddressesResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                AccountGetAddressesResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::GET if path.matched(paths::ID_ACCOUNT_BALANCES) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.account_get_balances(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                AccountGetBalancesResponse::BalancesFetchedSuccessfuly
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                AccountGetBalancesResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                AccountGetBalancesResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                AccountGetBalancesResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::GET if path.matched(paths::ID_ALIASES_ALIAS) => {
                ...
                let path_params =
                    paths::REGEX_ALIASES_ALIAS
                    .captures(path)
                    .unwrap_or_else(||
                        panic!("Path {} matched RE ALIASES_ALIAS in set but failed match against \"{}\"", path, paths::REGEX_ALIASES_ALIAS.as_str())
                    );

                let param_alias = match percent_encoding::percent_decode(path_params["alias"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                        .status(StatusCode::BAD_REQUEST)
                                        .body(Body::from(format!("Couldn't percent-decode path parameter as UTF-8: {}", &path_params["alias"])))
                                        .expect("Unable to create Bad Request response for invalid percent decode"))
                };

                                let result = api_impl.aliases_get_alias(
                                            param_alias,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                AliasesGetAliasResponse::HOPRAddressWasFoundForTheProvidedAlias
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                AliasesGetAliasResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                AliasesGetAliasResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                AliasesGetAliasResponse::ThisAliasWasNotAssignedToAnyPeerIdBefore
                                                    (body)
                                                => {
                                                ...
                                                AliasesGetAliasResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::GET if path.matched(paths::ID_ALIASES_) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.aliases_get_aliases(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                AliasesGetAliasesResponse::ReturnsListOfAliasesAndCorrespondingPeerIds
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                AliasesGetAliasesResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::DELETE if path.matched(paths::ID_ALIASES_ALIAS) => {
                ...
                let param_alias = match percent_encoding::percent_decode(path_params["alias"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                ...
                                let result = api_impl.aliases_remove_alias(
                                            param_alias,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                ...
                                                AliasesRemoveAliasResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                AliasesRemoveAliasResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                AliasesRemoveAliasResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::POST if path.matched(paths::ID_CHANNELS_CHANNELID_TICKETS_AGGREGATE) => {
                ...
                let param_channelid = match percent_encoding::percent_decode(path_params["channelid"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                        .status(StatusCode::BAD_REQUEST)
                                        .body(Body::from(format!("Couldn't percent-decode path parameter as UTF-8: {}", &path_params["channelid"])))
                                        .expect("Unable to create Bad Request response for invalid percent decode"))
                };

                                let result = api_impl.channels_aggregate_tickets(
                                            param_channelid,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                ...
                                                ChannelsAggregateTicketsResponse::InvalidChannelId
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(400).expect("Unable to turn 400 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsAggregateTicketsResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsAggregateTicketsResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsAggregateTicketsResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::DELETE if path.matched(paths::ID_CHANNELS_CHANNELID_) => {
                ...
                let path: &str = uri.path();
                let path_params =
                    paths::REGEX_CHANNELS_CHANNELID_
                    .captures(path)
                    .unwrap_or_else(||
                        panic!("Path {} matched RE CHANNELS_CHANNELID_ in set but failed match against \"{}\"", path, paths::REGEX_CHANNELS_CHANNELID_.as_str())
                    );
                ...
                let param_channelid = match percent_encoding::percent_decode(path_params["channelid"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                ...
                                let result = api_impl.channels_close_channel(
                                            param_channelid,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                ChannelsCloseChannelResponse::ChannelClosedSuccesfully
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsCloseChannelResponse::InvalidChannelId
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(400).expect("Unable to turn 400 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsCloseChannelResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsCloseChannelResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsCloseChannelResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::POST if path.matched(paths::ID_CHANNELS_CHANNELID_FUND) => {
                ...
                let path: &str = uri.path();
                let path_params =
                    paths::REGEX_CHANNELS_CHANNELID_FUND
                    .captures(path)
                    .unwrap_or_else(||
                        panic!("Path {} matched RE CHANNELS_CHANNELID_FUND in set but failed match against \"{}\"", path, paths::REGEX_CHANNELS_CHANNELID_FUND.as_str())
                    );
            ...
            hyper::Method::GET if path.matched(paths::ID_CHANNELS_CHANNELID_) => {
                ...
                let param_channelid = match percent_encoding::percent_decode(path_params["channelid"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                ...
                                let result = api_impl.channels_get_channel(
                                            param_channelid,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                ChannelsGetChannelResponse::ChannelFetchedSuccesfully
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsGetChannelResponse::InvalidChannelId
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(400).expect("Unable to turn 400 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsGetChannelResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsGetChannelResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsGetChannelResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::GET if path.matched(paths::ID_CHANNELS_) => {
                ...
                let param_including_closed = query_params.iter().filter(|e| e.0 == "includingClosed").map(|e| e.1.clone())
                    .next();
                ...
                let param_full_topology = query_params.iter().filter(|e| e.0 == "fullTopology").map(|e| e.1.clone())
                    .next();
                let param_full_topology = match param_full_topology {
                    Some(param_full_topology) => {
                        let param_full_topology =
                            <String as std::str::FromStr>::from_str
                                (&param_full_topology);
                    ...
                    None => None,
                                ...
                                let result = api_impl.channels_get_channels(
                                            param_including_closed,
                                            param_full_topology,
                                        &context
                                    ).await;
                                ...
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                ChannelsGetChannelsResponse::ChannelsFetchedSuccessfully
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsGetChannelsResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsGetChannelsResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsGetChannelsResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::GET if path.matched(paths::ID_CHANNELS_CHANNELID_TICKETS) => {
                ...
                let path: &str = uri.path();
                let path_params =
                    paths::REGEX_CHANNELS_CHANNELID_TICKETS
                    .captures(path)
                    .unwrap_or_else(||
                        panic!("Path {} matched RE CHANNELS_CHANNELID_TICKETS in set but failed match against \"{}\"", path, paths::REGEX_CHANNELS_CHANNELID_TICKETS.as_str())
                    );
                ...
                let param_channelid = match percent_encoding::percent_decode(path_params["channelid"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                ...
                                let result = api_impl.channels_get_tickets(
                                            param_channelid,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                ChannelsGetTicketsResponse::TicketsFetchedSuccessfully
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsGetTicketsResponse::InvalidPeerId
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(400).expect("Unable to turn 400 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsGetTicketsResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsGetTicketsResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsGetTicketsResponse::TicketsWereNotFoundForThatChannel
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(404).expect("Unable to turn 404 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsGetTicketsResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::POST if path.matched(paths::ID_CHANNELS_CHANNELID_TICKETS_REDEEM) => {
                ...
                let param_channelid = match percent_encoding::percent_decode(path_params["channelid"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                ...
                                let result = api_impl.channels_redeem_tickets(
                                            param_channelid,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                ...
                                                ChannelsRedeemTicketsResponse::InvalidChannelId
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(400).expect("Unable to turn 400 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsRedeemTicketsResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsRedeemTicketsResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsRedeemTicketsResponse::TicketsWereNotFoundForThatChannel
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(404).expect("Unable to turn 404 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                ChannelsRedeemTicketsResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::GET if path.matched(paths::ID_HEALTHYZ_) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.check_node_healthy(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                CheckNodeHealthyResponse::TheNodeIsReady
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                CheckNodeHealthyResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                CheckNodeHealthyResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                CheckNodeHealthyResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::GET if path.matched(paths::ID_READYZ_) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.check_node_ready(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                CheckNodeReadyResponse::TheNodeIsReady
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                CheckNodeReadyResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                CheckNodeReadyResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                CheckNodeReadyResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
                                                        CONTENT_TYPE,
                                                        HeaderValue::from_str("application/json")
                                                            .expect("Unable to create Content-Type header for CHECK_NODE_READY_UNKNOWN_FAILURE"));
                                                    let body = serde_json::to_string(&body).expect("impossible to fail to serialize");
                                                    *response.body_mut() = Body::from(body);
                                                },
                                            },
            ...
            hyper::Method::GET if path.matched(paths::ID_STARTEDZ_) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.check_node_started(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                CheckNodeStartedResponse::TheNodeIsStarted
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                CheckNodeStartedResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                CheckNodeStartedResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                CheckNodeStartedResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::DELETE if path.matched(paths::ID_MESSAGES_) => {
                ...
                // Query parameters (note that non-required or collection query parameters will ignore garbage values, rather than causing a 400 response)
                let query_params = form_urlencoded::parse(uri.query().unwrap_or_default().as_bytes()).collect::<Vec<_>>();
                let param_tag = query_params.iter().filter(|e| e.0 == "tag").map(|e| e.1.clone())
                    .next();
                let param_tag = match param_tag {
                    Some(param_tag) => {
                        ...
                        match param_tag {
                            ...
                            Err(e) => return Ok(Response::builder()
                                .status(StatusCode::BAD_REQUEST)
                                .body(Body::from(format!("Couldn't parse query parameter tag - doesn't match schema: {}", e)))
                                .expect("Unable to create Bad Request response for invalid query parameter tag")),
                        }
                    },
                    None => None,
                };
                let param_tag = match param_tag {
                    ...
                    None => return Ok(Response::builder()
                        ...
                        .expect("Unable to create Bad Request response for missing query parameter tag")),
                                ...
                                let result = api_impl.messages_delete_messages(
                                            param_tag,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                ...
                                                MessagesDeleteMessagesResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                MessagesDeleteMessagesResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                ...
                let param_tag = match param_tag {
                    ...
                    None => return Ok(Response::builder()
                        ...
                        .expect("Unable to create Bad Request response for missing query parameter tag")),
                                ...
                                let result = api_impl.messages_get_size(
                                            param_tag,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                MessagesGetSizeResponse::ReturnsTheMessageInboxSizeFilteredByTheGivenTag
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                MessagesGetSizeResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                MessagesGetSizeResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                MessagesGetSizeResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::GET if path.matched(paths::ID_MESSAGES_WEBSOCKET) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.messages_websocket(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                ...
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(101).expect("Unable to turn 101 into a StatusCode");
                                                },
                                                MessagesWebsocketResponse::IncomingData
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(206).expect("Unable to turn 206 into a StatusCode");
                                                    response.headers_mut().insert(
                                                        ...
                                                        HeaderValue::from_str("application/text")
                                                            .expect("Unable to create Content-Type header for MESSAGES_WEBSOCKET_INCOMING_DATA"));
                                                    let body = body;
                                                    *response.body_mut() = Body::from(body);
                                                },
                                                MessagesWebsocketResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                MessagesWebsocketResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::GET if path.matched(paths::ID_NODE_ENTRYNODES) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.node_get_entry_nodes(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                NodeGetEntryNodesResponse::EntryNodeInformationFetchedSuccessfuly
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetEntryNodesResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetEntryNodesResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetEntryNodesResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::GET if path.matched(paths::ID_NODE_INFO) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.node_get_info(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                NodeGetInfoResponse::NodeInformationFetchedSuccessfuly
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetInfoResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetInfoResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetInfoResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
                                                        CONTENT_TYPE,
                                                        HeaderValue::from_str("application/json")
                                                            .expect("Unable to create Content-Type header for NODE_GET_INFO_UNKNOWN_FAILURE"));
                                                    let body = serde_json::to_string(&body).expect("impossible to fail to serialize");
                                                    *response.body_mut() = Body::from(body);
                                                },
                                            },
            ...
            hyper::Method::GET if path.matched(paths::ID_NODE_METRICS) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.node_get_metrics(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                NodeGetMetricsResponse::ReturnsTheEncodedSerializedMetrics
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetMetricsResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetMetricsResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetMetricsResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
                                                        CONTENT_TYPE,
                                                        HeaderValue::from_str("application/json")
                                                            .expect("Unable to create Content-Type header for NODE_GET_METRICS_UNKNOWN_FAILURE"));
                                                    let body = serde_json::to_string(&body).expect("impossible to fail to serialize");
                                                    *response.body_mut() = Body::from(body);
                                                },
                                            },
            ...
            hyper::Method::GET if path.matched(paths::ID_NODE_PEERS) => {
                ...
                // Query parameters (note that non-required or collection query parameters will ignore garbage values, rather than causing a 400 response)
                let query_params = form_urlencoded::parse(uri.query().unwrap_or_default().as_bytes()).collect::<Vec<_>>();
                let param_quality = query_params.iter().filter(|e| e.0 == "quality").map(|e| e.1.clone())
                    .next();
                let param_quality = match param_quality {
                    ...
                    None => None,
                                ...
                                let result = api_impl.node_get_peers(
                                            param_quality,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                NodeGetPeersResponse::PeersInformationFetchedSuccessfuly
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetPeersResponse::InvalidInput
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(400).expect("Unable to turn 400 into a StatusCode");
                                                    response.headers_mut().insert(
                                                        CONTENT_TYPE,
                                                        HeaderValue::from_str("application/json")
                                                            .expect("Unable to create Content-Type header for NODE_GET_PEERS_INVALID_INPUT"));
                                                    let body = serde_json::to_string(&body).expect("impossible to fail to serialize");
                                                    *response.body_mut() = Body::from(body);
                                                },
                                                NodeGetPeersResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetPeersResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetPeersResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
                                                        CONTENT_TYPE,
                                                        HeaderValue::from_str("application/json")
                                                            .expect("Unable to create Content-Type header for NODE_GET_PEERS_UNKNOWN_FAILURE"));
                                                    let body = serde_json::to_string(&body).expect("impossible to fail to serialize");
                                                    *response.body_mut() = Body::from(body);
                                                },
                                            },
            ...
            hyper::Method::GET if path.matched(paths::ID_NODE_VERSION) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.node_get_version(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                NodeGetVersionResponse::ReturnsTheReleaseVersionOfTheRunningNode
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetVersionResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetVersionResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                NodeGetVersionResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
                                                        CONTENT_TYPE,
                                                        HeaderValue::from_str("application/json")
                                                            .expect("Unable to create Content-Type header for NODE_GET_VERSION_UNKNOWN_FAILURE"));
                                                    let body = serde_json::to_string(&body).expect("impossible to fail to serialize");
                                                    *response.body_mut() = Body::from(body);
                                                },
                                            },
            ...
            hyper::Method::GET if path.matched(paths::ID_PEERS_PEERID_) => {
                ...
                let path: &str = uri.path();
                let path_params =
                    paths::REGEX_PEERS_PEERID_
                    .captures(path)
                    .unwrap_or_else(||
                        panic!("Path {} matched RE PEERS_PEERID_ in set but failed match against \"{}\"", path, paths::REGEX_PEERS_PEERID_.as_str())
                    );

                let param_peerid = match percent_encoding::percent_decode(path_params["peerid"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                        .status(StatusCode::BAD_REQUEST)
                                        .body(Body::from(format!("Couldn't percent-decode path parameter as UTF-8: {}", &path_params["peerid"])))
                                        .expect("Unable to create Bad Request response for invalid percent decode"))
                };

                                let result = api_impl.peer_info_get_peer_info(
                                            param_peerid,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                PeerInfoGetPeerInfoResponse::PeerInformationFetchedSuccessfully
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                PeerInfoGetPeerInfoResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                PeerInfoGetPeerInfoResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                PeerInfoGetPeerInfoResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::POST if path.matched(paths::ID_PEERS_PEERID_PING) => {
                ...
                let path: &str = uri.path();
                let path_params =
                    paths::REGEX_PEERS_PEERID_PING
                    .captures(path)
                    .unwrap_or_else(||
                        panic!("Path {} matched RE PEERS_PEERID_PING in set but failed match against \"{}\"", path, paths::REGEX_PEERS_PEERID_PING.as_str())
                    );
                ...
                let param_peerid = match percent_encoding::percent_decode(path_params["peerid"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                ...
                                let result = api_impl.peers_ping_peer(
                                            param_peerid,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                PeersPingPeerResponse::PingSuccessful
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                        CONTENT_TYPE,
                                                        HeaderValue::from_str("application/json")
                                                            .expect("Unable to create Content-Type header for PEERS_PING_PEER_PING_SUCCESSFUL"));
                                                    let body = serde_json::to_string(&body).expect("impossible to fail to serialize");
                                                    *response.body_mut() = Body::from(body);
                                                },
                                                PeersPingPeerResponse::InvalidPeerId
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(400).expect("Unable to turn 400 into a StatusCode");
                                                    response.headers_mut().insert(
                                                        CONTENT_TYPE,
                                                        HeaderValue::from_str("application/json")
                                                            .expect("Unable to create Content-Type header for PEERS_PING_PEER_INVALID_PEER_ID"));
                                                    let body = serde_json::to_string(&body).expect("impossible to fail to serialize");
                                                    *response.body_mut() = Body::from(body);
                                                },
                                                PeersPingPeerResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                PeersPingPeerResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                PeersPingPeerResponse::AnErrorOccured
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
                                                        CONTENT_TYPE,
                                                        HeaderValue::from_str("application/json")
                                                            .expect("Unable to create Content-Type header for PEERS_PING_PEER_AN_ERROR_OCCURED"));
                                                    let body = serde_json::to_string(&body).expect("impossible to fail to serialize");
                                                    *response.body_mut() = Body::from(body);
                                                },
                                            },
            ...
            hyper::Method::GET if path.matched(paths::ID_SETTINGS_) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.settings_get_settings(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                SettingsGetSettingsResponse::SettingsFetchedSuccesfully
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                SettingsGetSettingsResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                SettingsGetSettingsResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                SettingsGetSettingsResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::PUT if path.matched(paths::ID_SETTINGS_SETTING) => {
                ...
                let path: &str = uri.path();
                let path_params =
                    paths::REGEX_SETTINGS_SETTING
                    .captures(path)
                    .unwrap_or_else(||
                        panic!("Path {} matched RE SETTINGS_SETTING in set but failed match against \"{}\"", path, paths::REGEX_SETTINGS_SETTING.as_str())
                    );

                let param_setting = match percent_encoding::percent_decode(path_params["setting"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                        .status(StatusCode::BAD_REQUEST)
                                        .body(Body::from(format!("Couldn't percent-decode path parameter as UTF-8: {}", &path_params["setting"])))
                                        .expect("Unable to create Bad Request response for invalid percent decode"))
                };
            ...
            hyper::Method::GET if path.matched(paths::ID_TICKETS_STATISTICS) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.tickets_get_statistics(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                TicketsGetStatisticsResponse::TicketsStatisticsFetchedSuccessfully
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                TicketsGetStatisticsResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                TicketsGetStatisticsResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                TicketsGetStatisticsResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::GET if path.matched(paths::ID_TICKETS_) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.tickets_get_tickets(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                TicketsGetTicketsResponse::TicketsFetchedSuccessfully
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                TicketsGetTicketsResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                TicketsGetTicketsResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                TicketsGetTicketsResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::POST if path.matched(paths::ID_TICKETS_REDEEM) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.tickets_redeem_tickets(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                ...
                                                TicketsRedeemTicketsResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                TicketsRedeemTicketsResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                TicketsRedeemTicketsResponse::UnknownFailure
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(422).expect("Unable to turn 422 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::DELETE if path.matched(paths::ID_TOKENS_ID) => {
                ...
                let path: &str = uri.path();
                let path_params =
                    paths::REGEX_TOKENS_ID
                    .captures(path)
                    .unwrap_or_else(||
                        panic!("Path {} matched RE TOKENS_ID in set but failed match against \"{}\"", path, paths::REGEX_TOKENS_ID.as_str())
                    );
                ...
                let param_id = match percent_encoding::percent_decode(path_params["id"].as_bytes()).decode_utf8() {
                    ...
                    Err(_) => return Ok(Response::builder()
                                ...
                                let result = api_impl.tokens_delete(
                                            param_id,
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                ...
                                                TokensDeleteResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                TokensDeleteResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
            ...
            hyper::Method::GET if path.matched(paths::ID_TOKEN) => {
                {
                    let authorization = match *(&context as &dyn Has<Option<Authorization>>).get() {
                        ...
                        None => return Ok(Response::builder()
                                ...
                                let result = api_impl.tokens_get_token(
                                        &context
                                    ).await;
                                let mut response = Response::new(Body::empty());
                                response.headers_mut().insert(
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                TokensGetTokenResponse::TokenInformation
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(200).expect("Unable to turn 200 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                TokensGetTokenResponse::AuthenticationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(401).expect("Unable to turn 401 into a StatusCode");
                                                    response.headers_mut().insert(
                                                ...
                                                TokensGetTokenResponse::AuthorizationFailed
                                                    (body)
                                                => {
                                                    *response.status_mut() = StatusCode::from_u16(403).expect("Unable to turn 403 into a StatusCode");
                                                    response.headers_mut().insert(
...
impl<T> RequestParser<T> for ApiRequestParser {
    fn parse_operation_id(request: &Request<T>) -> Option<&'static str> {
        ...
        match *request.method() {
            ...
            // ChannelsAggregateTickets - POST /channels/{channelid}/tickets/aggregate
            hyper::Method::POST if path.matched(paths::ID_CHANNELS_CHANNELID_TICKETS_AGGREGATE) => Some("ChannelsAggregateTickets"),
            // ChannelsCloseChannel - DELETE /channels/{channelid}/
            ...
            // ChannelsRedeemTickets - POST /channels/{channelid}/tickets/redeem
            hyper::Method::POST if path.matched(paths::ID_CHANNELS_CHANNELID_TICKETS_REDEEM) => Some("ChannelsRedeemTickets"),
            // CheckNodeHealthy - GET /healthyz/
