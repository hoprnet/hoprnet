...
fn main() {
    ...
    match matches.value_of("operation") {
        ...
        Some("AccountWithdraw") => {
            let result = rt.block_on(client.account_withdraw(
                  None
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("AliasesGetAlias") => {
            let result = rt.block_on(client.aliases_get_alias(
                  "Alice".to_string()
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        ...
        Some("AliasesRemoveAlias") => {
            let result = rt.block_on(client.aliases_remove_alias(
                  "Alice".to_string()
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("AliasesSetAlias") => {
            let result = rt.block_on(client.aliases_set_alias(
                  None
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("ChannelsAggregateTickets") => {
            let result = rt.block_on(client.channels_aggregate_tickets(
                  "channelid_example".to_string()
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("ChannelsCloseChannel") => {
            let result = rt.block_on(client.channels_close_channel(
                  "channelid_example".to_string()
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("ChannelsFundChannel") => {
            let result = rt.block_on(client.channels_fund_channel(
                  "channelid_example".to_string(),
                  None
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        ...
        */
        Some("ChannelsGetChannels") => {
            let result = rt.block_on(client.channels_get_channels(
        ...
        Some("ChannelsGetTickets") => {
            let result = rt.block_on(client.channels_get_tickets(
                  "channelid_example".to_string()
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("ChannelsOpenChannel") => {
            let result = rt.block_on(client.channels_open_channel(
                  None
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("ChannelsRedeemTickets") => {
            let result = rt.block_on(client.channels_redeem_tickets(
                  "channelid_example".to_string()
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        ...
        Some("MessagesDeleteMessages") => {
            let result = rt.block_on(client.messages_delete_messages(
                  56
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("MessagesGetSize") => {
            let result = rt.block_on(client.messages_get_size(
                  56
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("MessagesPopAllMessage") => {
            let result = rt.block_on(client.messages_pop_all_message(
                  None
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("MessagesPopMessage") => {
            let result = rt.block_on(client.messages_pop_message(
                  None
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("MessagesSendMessage") => {
            let result = rt.block_on(client.messages_send_message(
                  None
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        ...
        Some("NodeGetPeers") => {
            let result = rt.block_on(client.node_get_peers(
                  Some(0.5)
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        ...
        Some("PeerInfoGetPeerInfo") => {
            let result = rt.block_on(client.peer_info_get_peer_info(
                  "peerid_example".to_string()
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("PeersPingPeer") => {
            let result = rt.block_on(client.peers_ping_peer(
                  "peerid_example".to_string()
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        ...
        Some("SettingsSetSetting") => {
            let result = rt.block_on(client.settings_set_setting(
        ...
        Some("TokensCreate") => {
            let result = rt.block_on(client.tokens_create(
                  None
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("TokensDelete") => {
            let result = rt.block_on(client.tokens_delete(
                  "someTOKENid1234".to_string()
            ));
            info!("{:?} (X-Span-ID: {:?})", result, (client.context() as &dyn Has<XSpanIdString>).get().clone());
        },
        Some("TokensGetToken") => {
