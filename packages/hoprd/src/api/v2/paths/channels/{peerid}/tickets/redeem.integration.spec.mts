...
import { createTestApiInstance, ALICE_PEER_ID, INVALID_PEER_ID } from '../../../../fixtures.mjs'
...
describe('POST /channels/{peerId}/tickets/redeem', () => {
  ...
  it('should redeem tickets successfully', async () => {
    const res = await request(service).post(`/api/v2/channels/${ALICE_PEER_ID.toB58String()}/tickets/redeem`)
