...
node.getAddressesAnnouncedToDHT = sinon.fake.resolves([ALICE_MULTI_ADDR.toString(), BOB_MULTI_ADDR.toString()])
node.getObservedAddresses = sinon.fake.returns([ALICE_MULTI_ADDR.toString()])
