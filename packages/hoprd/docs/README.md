...
Options:
  ...
  --admin                       Run an admin interface and WS v1 on localhost:3000, requires --apiToken  [boolean] [default: false]
  ...
  --apiHost, --restHost         Set host IP to which both Rest and Websocket API server will bind. "--restHost" is deprecated.  [string] [default: "localhost"]
  --apiPort, --restPort         Set host port to which both Rest and Websocket API server will bind. "--restPort" is deprecated.  [number] [default: 3001]
