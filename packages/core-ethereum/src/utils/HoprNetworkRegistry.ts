...
import type {
  ...
  export interface HoprNetworkRegistryInterface extends utils.Interface {
    ...
    encodeFunctionData(
      functionFragment: "isAccountRegisteredAndEligible",
      values: [string]
    ): string;
    encodeFunctionData(
    ...
    encodeFunctionData(
      functionFragment: "nodePeerIdToAccount",
      values: [string]
    ): string;
    encodeFunctionData(functionFragment: "owner", values?: undefined): string;
    encodeFunctionData(
      functionFragment: "ownerDeregister",
      values: [string[]]
    ): string;
    encodeFunctionData(
      functionFragment: "ownerForceEligibility",
      values: [string[], boolean[]]
    ): string;
    encodeFunctionData(
      functionFragment: "ownerRegister",
  ...
  export type DeregisteredByOwnerEvent = TypedEvent<
    [string, string],
    DeregisteredByOwnerEventObject
  >;
  
  export type DeregisteredByOwnerEventFilter =
    TypedEventFilter<DeregisteredByOwnerEvent>;
  ...
  export type RegisteredByOwnerEvent = TypedEvent<
    [string, string],
    RegisteredByOwnerEventObject
  >;
  
  export type RegisteredByOwnerEventFilter =
    TypedEventFilter<RegisteredByOwnerEvent>;
  ...
  export interface HoprNetworkRegistry extends BaseContract {
    ...
    filters: {
      ...
      "DeregisteredByOwner(address,string)"(
        account?: string | null,
        hoprPeerId?: null
      ): DeregisteredByOwnerEventFilter;
      DeregisteredByOwner(
        account?: string | null,
        hoprPeerId?: null
      ): DeregisteredByOwnerEventFilter;
      ...
      "RegisteredByOwner(address,string)"(
        account?: string | null,
        hoprPeerId?: null
      ): RegisteredByOwnerEventFilter;
      RegisteredByOwner(
        account?: string | null,
        hoprPeerId?: null
      ): RegisteredByOwnerEventFilter;
