...
export const PARTY_A = PublicKey.fromUncompressedPubKey(stringToU8a(ACCOUNT_A.publicKey))
export const PARTY_A_MULTIADDR = new Multiaddr(`/ip4/34.65.237.196/tcp/9091/p2p/${PARTY_A.toPeerId()}`)
export const ACCOUNT_B = new Wallet('0x4471496ef88d9a7d86a92b7676f3c8871a60792a37fae6fc3abc347c3aa3b16b')
export const PARTY_B = PublicKey.fromUncompressedPubKey(stringToU8a(ACCOUNT_B.publicKey))
export const PARTY_B_MULTIADDR = new Multiaddr(`/ip4/34.65.237.197/tcp/9091/p2p/${PARTY_B.toPeerId()}`)
...
export const UNIT_TEST_MAX_CONFIRMATIONS = 2