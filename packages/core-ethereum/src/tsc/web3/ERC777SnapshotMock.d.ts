...
export class ERC777SnapshotMock extends Contract {
  ...
  methods: {
    ...
    getAccountValueAt(_owner: string, _blockNumber: number | string): TransactionObject<string>

    getTotalSupplyValueAt(_blockNumber: number | string): TransactionObject<string>
    ...
    updateValueAtNowAccount(account: string, value: number | string): TransactionObject<void>
  }
  events: {
