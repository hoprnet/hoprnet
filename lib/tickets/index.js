    ...
    async get(channelId) {
        ...
        return new Promise(async (resolve, reject) => {
            this.coreConnector.db
                .createReadStream({
                gte: Buffer.from(this.coreConnector.dbKeys.Ticket(channelId, new Uint8Array(types_1.Hash.SIZE).fill(0x00))),
                lte: Buffer.from(this.coreConnector.dbKeys.Ticket(channelId, new Uint8Array(types_1.Hash.SIZE).fill(0xff))),
            })
