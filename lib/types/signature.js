...
class Signature extends extended_1.Uint8ArrayE {
    constructor(arr, struct) {
        if (arr != null && struct == null) {
            ...
            super(hopr_utils_1.u8aConcat(struct.signature, new Uint8Array([struct.recovery])));
        }
        else {
    ...
    get recovery() {
        return hopr_utils_1.u8aToNumber(this.subarray(constants_1.SIGNATURE_LENGTH, constants_1.SIGNATURE_LENGTH + constants_1.SIGNATURE_RECOVERY_LENGTH));
    }
    get msgPrefix() {
