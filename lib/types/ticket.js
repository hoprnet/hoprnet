...
const hashedSecret_1 = require("../hashedSecret");
//
...
class Ticket extends extended_1.Uint8ArrayE {
    ...
    get onChainSecret() {
        return new Uint8Array(this.buffer, this.onChainSecretOffset, hashedSecret_1.HASHED_SECRET_WIDTH);
    }
    get hash() {
        return new Promise(async (resolve) => {
            const encodedTicket = encode([
                { type: 'bytes32', value: hopr_utils_1.u8aToHex(this.channelId) },
                { type: 'bytes32', value: hopr_utils_1.u8aToHex(await utils_1.hash(this.challenge)) },
    ...
    async sign(privKey, pubKey, arr) {
        return utils_1.sign(await this.hash, privKey, undefined, arr);
    }
