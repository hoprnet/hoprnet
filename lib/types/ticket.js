...
class Ticket extends extended_1.Uint8ArrayE {
    ...
    static async create(channel, amount, challenge, arr) {
        ...
        const { hashedSecret } = await channel.coreConnector.hoprChannels.methods.accounts(hopr_utils_1.u8aToHex(account)).call();
        ...
        await utils_1.sign(await ticket.hash, channel.coreConnector.self.privateKey, undefined, {
            bytes: signedTicket.buffer,
