...
class Ticket extends extended_1.Uint8ArrayE {
    constructor(arr, struct) {
        if (arr != null && struct == null) {
            ...
            super(hopr_utils_1.u8aConcat(new _1.Hash(struct.channelId).toU8a(), new _1.Hash(struct.challenge).toU8a(), new _1.TicketEpoch(struct.epoch).toU8a(), new _1.Balance(struct.amount).toU8a(), new _1.Hash(struct.winProb).toU8a(), new _1.Hash(struct.onChainSecret).toU8a()));
        }
        else {
    ...
    get hash() {
        return utils_1.hash(hopr_utils_1.u8aConcat(this.challenge, this.onChainSecret, this.epoch.toU8a(), new Uint8Array(this.amount.toNumber()), this.winProb));
    }
    static get SIZE() {
    ...
    static async create(channel, amount, challenge) {
        ...
        const { hashedSecret } = await channel.coreConnector.hoprChannels.methods
            .accounts(hopr_utils_1.u8aToHex(account))
            .call();
