...
class HoprEthereum {
    constructor(db, self, account, web3, network, hoprChannels, hoprToken, options) {
        ...
        this.channel = {
            isOpen: channel_1.default.isOpen.bind(this),
            increaseFunds: channel_1.default.increaseFunds.bind(this),
            createDummyChannelTicket: channel_1.default.createDummyChannelTicket.bind(this),
            create: channel_1.default.create.bind(this),
            getAll: channel_1.default.getAll.bind(this),
            closeChannels: channel_1.default.closeChannels.bind(this),
            handleOpeningRequest: channel_1.default.handleOpeningRequest.bind(this),
        };
