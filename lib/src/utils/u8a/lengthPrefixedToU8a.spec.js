...
describe('test length-prefixed to u8a', function () {
    it('should convert a length-prefixed u8a to u8a', function () {
        ...
        assert_1.default.throws(() => lengthPrefixedToU8a_1.lengthPrefixedToU8a(new Uint8Array([]), undefined, 1));
        assert_1.default.deepEqual(lengthPrefixedToU8a_1.lengthPrefixedToU8a(new Uint8Array([0, 0, 0, 1, 1, 0]), undefined, 6), new Uint8Array([1]));
    });
    it('should convert a length-prefixed u8a with additional padding to u8a', function () {
        ...
        assert_1.default.deepEqual(lengthPrefixedToU8a_1.lengthPrefixedToU8a(new Uint8Array([0, 0, 0, 1, 1, 1, 0]), undefined, 7), new Uint8Array([1])), new Uint8Array([1]);
    });
});
