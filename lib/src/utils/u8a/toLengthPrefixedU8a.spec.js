...
describe('test u8a to length-prefixed u8a', function () {
    it('should return a length-prefixed u8a', function () {
        ...
        assert_1.default.throws(() => toLengthPrefixedU8a_1.toLengthPrefixedU8a(new Uint8Array([1]), undefined, 2));
        assert_1.default.deepEqual(toLengthPrefixedU8a_1.toLengthPrefixedU8a(new Uint8Array([1]), undefined, 6), new Uint8Array([0, 0, 0, 1, 1, 0]));
    });
