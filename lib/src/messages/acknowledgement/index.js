...
class Acknowledgement extends Uint8Array {
    constructor(paymentChannels, arr, struct) {
        if (arr != null && struct == null) {
            ...
            super(hopr_utils_1.u8aConcat(struct.key, struct.challenge, struct.signature != null ? struct.signature : new Uint8Array(paymentChannels.types.Signature.SIZE)));
        }
        else {
    ...
    get responseSigningParty() {
        ...
        return new Promise(async (resolve) => {
            this._responseSigningParty = secp256k1_1.default.ecdsaRecover(this.responseSignature.signature, this.responseSignature.recovery, await this.paymentChannels.utils.hash(hopr_utils_1.u8aConcat(this.responseSignature.msgPrefix, await this.hash)));
