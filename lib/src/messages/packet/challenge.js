...
class Challenge extends Uint8Array {
    ...
    get counterparty() {
        ...
        return new Promise(async (resolve) => {
            resolve(secp256k1_1.default.ecdsaRecover(this.challengeSignature.signature, this.challengeSignature.recovery, await this.paymentChannels.utils.hash(utils_1.u8aConcat(this.challengeSignature.msgPrefix, await this.hash))));
        });
    }
    /**
