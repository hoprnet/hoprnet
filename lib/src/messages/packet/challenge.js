...
class Challenge extends Uint8Array {
    ...
    get counterparty() {
        ...
        return new Promise(async (resolve) => {
            resolve(secp256k1_1.default.ecdsaRecover(this.challengeSignature.signature, this.challengeSignature.recovery, await this.paymentChannels.utils.hash(hopr_utils_1.u8aConcat(this.challengeSignature.msgPrefix, await this.hash))));
        });
    }
    /**
     ...
     * @param fee
     */
    static create(hoprCoreConnector, hashedKey, fee) {
