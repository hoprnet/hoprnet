...
class CrawlResponse extends Uint8Array {
    constructor(arr, struct) {
        if (arr != null && struct == null) {
            ...
            if (struct.peerInfos == null) {
                ...
                super(utils_1.u8aConcat(utils_1.toU8a(struct.status, ENUM_LENGTH)));
            }
            else if (struct.status == _1.CrawlStatus.OK) {
                super(utils_1.u8aConcat(utils_1.toU8a(struct.status, ENUM_LENGTH), rlp_1.encode(struct.peerInfos.map((peerInfo) => utils_1.serializePeerInfo(peerInfo)))));
            }
            else {
    ...
    get status() {
        return utils_1.u8aToNumber(this.statusRaw);
    }
    get peerInfosRaw() {
