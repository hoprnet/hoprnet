    ...
    async sendMessage(msg, destination, getIntermediateNodesManually) {
        ...
        for (let n = 0; n < msg.length / constants_1.PACKET_SIZE; n++) {
            promises.push(new Promise(async (resolve, reject) => {
                ...
                this.interactions.packet.acknowledgment.once(hopr_utils_1.u8aToHex(this.dbKeys.UnAcknowledgedTickets(path[0].pubKey.marshal(), packet.ticket.ticket.challenge)), () => {
