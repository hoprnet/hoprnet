...
class TicketFactory {
    ...
    async submit(signedTicket) {
        ...
        const transaction = await signTransaction(hoprChannels.methods.redeemTicket(hopr_utils_1.u8aToHex(ticket.challenge), hopr_utils_1.u8aToHex(ticket.channelId), hopr_utils_1.u8aToHex(ticket.onChainSecret), hopr_utils_1.u8aToHex(counterPartySecret), ticket.amount.toString(), hopr_utils_1.u8aToHex(ticket.winProb), hopr_utils_1.u8aToHex(r), hopr_utils_1.u8aToHex(s), v), {
