...
class TicketFactory {
    ...
    async create(amount, challenge, arr) {
        ...
        await this.channel.coreConnector.utils.sign(await ticket.hash, this.channel.coreConnector.self.privateKey, undefined, {
            bytes: signedTicket.buffer,
    ...
    async verify(signedTicket) {
        ...
        return this.channel.coreConnector.utils.verify(await signedTicket.ticket.hash, signedTicket.signature, await this.channel.offChainCounterparty);
    }
