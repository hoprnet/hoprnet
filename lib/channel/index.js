...
const channelInstance_1 = __importDefault(require("./channelInstance"));
...
class ChannelFactory {
    ...
    async create(counterpartyPubKey, _getOnChainPublicKey, channelBalance, sign) {
        ...
        if (await this.isOpen(counterpartyPubKey)) {
            ...
            channel = new channelInstance_1.default(this.coreConnector, counterpartyPubKey, signedChannel);
        }
    ...
    getAll(onData, onEnd) {
        ...
        return new Promise((resolve, reject) => {
            this.coreConnector.db
                ...
                promises.push(onData(new channelInstance_1.default(this.coreConnector, this.coreConnector.dbKeys.ChannelKeyParse(key), signedChannel)));
            })
...
exports.default = channelInstance_1.default;
