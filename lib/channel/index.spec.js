...
describe('test ticket generation and verification', function () {
    ...
    it('should create a valid ticket', async function () {
        ...
        assert_1.default(u8a.u8aEquals(await ticket.signer, coreConnector.self.publicKey), `Check that signer is recoverable`);
        ...
        assert_1.default(u8a.u8aEquals(dbChannels[0].counterparty, coreConnector.self.onChainKeyPair.publicKey), `Channel record should make it into the database and its db-key should lead to the AccountId of the counterparty.`);
