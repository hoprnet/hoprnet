...
const pair = {
    privKey: hopr_utils_1.stringToU8a('0x9feaac2858974b0e16f6e3cfa7c21db6c7bbcd2094daa651ff3d5bb48a57b759'),
    pubKey: hopr_utils_1.stringToU8a('0x03950056bd3c566eb3ac90b4e8cb0e93a648bf8000833161d679bd802505b224b5'),
    address: hopr_utils_1.stringToU8a('0x81E1192eae6d7289A610956CaE1C4b76e083Eb39')
};
const generatePair = () => {
...
describe('test utils', function () {
    ...
    it('should sign and verify signer', async function () {
        ...
        assert_1.default(hopr_utils_1.u8aEquals(pubKey, signer), `check that message is signed correctly`);
    });
    ...
    it('should get private key using public key', async function () {
        ...
        assert_1.default(hopr_utils_1.u8aEquals(pubKey, pair.pubKey));
    });
    it('should get address using public key', async function () {
        const address = await utils.pubKeyToAccountId(pair.pubKey);
        assert_1.default(hopr_utils_1.u8aEquals(address, pair.address));
    });
});
