...
exports.createChallage = exports.getSignatureParameters = exports.cleanupPromiEvent = exports.Log = exports.TransactionSigner = exports.stateCountToStatus = exports.getNetworkName = exports.getChainId = exports.waitFor = exports.wait = exports.waitForConfirmation = exports.convertUnit = exports.verify = exports.signer = exports.sign = exports.hash = exports.pubKeyToAccountId = exports.privKeyToPubKey = exports.getId = exports.getParties = exports.isPartyA = exports.time = void 0;
 ...
 */
async function createChallage(secretA, secretB) {
    return hash(hopr_utils_1.u8aConcat(secretA, secretB));
}
exports.createChallage = createChallage;
